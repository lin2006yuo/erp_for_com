...
<script>
    import {api_get_account,api_rsync_ebay_promotion,api_get_promotionList,api_edit_combList,api_delete_promotion} from '../../../../api/ebay-kandeng-public-module';
    import {url_delete_promotion,url_save_combList,url_rsync_ebay_promotion} from '../../../../api/ebay-kandeng-public-module';
    export default{
        permission:{
            url_save_combList,
        ...
        methods:{
            ...
            edit_promotion_rule(id){
                    ...
                    this.$http(api_edit_combList,params).then(res=>{
                        res.promotion = res.promotion?true:false;
                        res.promotion_trans = res.promotion_trans?true:false;
                        this.add_edit_form = res;
                        this.add_edit_form.end_date = res.end_date?new Date(res.end_date*1000):"";
                        this.add_edit_form.start_date = res.start_date?new Date(res.start_date*1000):"";
                    }).catch(code=>{
                        this.$message({type:"error", message: code.message || code});
                    });
            },
