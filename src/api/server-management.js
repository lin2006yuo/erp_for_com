...
//服务器获取密码
export const url_servers_pwd = "get|servers/:id/pwd";
export const api_servers_pwd = function (id,data) {
    return http(Url2(url_servers_pwd,{id:id}),data);
};

//批量通知
export const url_servers_notify = "post|servers/notify";
export const api_servers_notify = function (data) {
    return http(url_servers_notify,data);
};