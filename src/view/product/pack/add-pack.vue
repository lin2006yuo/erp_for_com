                ...
                <el-row>
                    <el-col :span="11">
                        <el-form-item label="供应商：" prop="supplier">
                            ...
                            <super-select v-model="packForm.supplier"
                                          storageKey="supplierList"
                                          :adjust-structure="adjust_structure"
                                          :remote-request-http="remoteRequestHttp"></super-select>
                        </el-form-item>
                    </el-col>
                </el-row>
...
<script>
    ...
    import {api_pack_getSupplier,api_pack_getCurrency, api_pack_add, api_pack_update} from '../../../api/pack';
    export default{
        data(){
