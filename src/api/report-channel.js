...
// 获取fba货品统计信息
export const url_fba_order_skus = 'get|report/financial/profit-statement/fba_order_skus';
export const api_fba_order_skus = function (data) {
    return http(url_fba_order_skus, data);
};
...
//priceMinister平台利润报表接口
export const url_report_price_minister = "get|report/financial/profit-statement/price-Minister";
export const api_report_price_minister = function(datas){
    return http(url_report_price_minister, datas, {
        contentType:'application/x-www-form-urlencoded',
        timeout:INFINITE
    });
};
...
//fummart平台利润报表接口
export const url_report_fummart = "get|report/financial/profit-statement/fummart";
export const api_report_fummart = function(datas){
    return http(url_report_fummart, datas, {
        contentType:'application/x-www-form-urlencoded',
        timeout:INFINITE
    });
};
...
//daraz平台利润报表接口
export const url_report_daraz = "get|report/financial/profit-statement/daraz";
export const api_report_daraz = function(datas){
    return http(url_report_daraz, datas, {
        contentType:'application/x-www-form-urlencoded',
        timeout:INFINITE
    });
};
...
export const api_get_user = data=> {
    return http(url_get_user,data);
};
