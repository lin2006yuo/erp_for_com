<template>
    <page class="channel-profit">
        <search-module @init-data="init_data" ref="search_module" :channel-id="1"></search-module>
...
<script>
    import {api_report_eBay} from  '@/api/report-channel'
        ...
        data(){
            return{
                ...
                header: [
                    ...
                    {label:'Paypal费用',size:100, value: 'mc_fee_CNY', handle: this.handle_number},
                    {label:'货币转换费用',size:100, value: 'currency_transform_fee', handle: this.handle_number},
                    ...
                    {label:'转运费',size:80, value: 'trans_shipping_fee', handle: this.to_fixed2},
