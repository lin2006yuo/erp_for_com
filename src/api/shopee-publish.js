...
// spu关联功能接口
export  const  url_publish_shopee_variant = 'get|publish/shopee/:id/skus';
export const api_publish_shopee_variant = function (id) {
    return http(Url2(url_publish_shopee_variant, {id:id}));
};
