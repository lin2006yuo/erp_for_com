        ...
        <div>
            <el-table
                ...
                <el-table-column
                        ...
                        label="速卖通状态"
                        align="center">
                    <div :class="parseInt(row.aliexpress_enabled)===0?'loseStatus':'sucStatus'">{{row.aliexpress_enabled |filterAliexpress}}</div>
                </el-table-column>
                ...
                <el-table-column
                    ...
                    <div>
                        ...
                        <permission
                            tag="span"
                            :route="apis.url_aliexpress_account_log">|</permission>
                        <permission tag="span"
                                    :route="apis.url_aliexpress_account_log"
                                    class="operate"
...
import {url_aliexpress_lookover,url_aliexpress_edit,url_aliexpress_accredit,url_add_member,url_aliexpress_states,url_get_topic_list,url_aliexpress_account_log} from "../../../../api/aliexpress";
