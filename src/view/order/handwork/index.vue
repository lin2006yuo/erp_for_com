...
<script>
    import {
        ...
        url_add_orders_offline,
        url_add_orders_reissue,
        url_add_orders_price,
        url_post_import_offline,
        url_post_import_reissue,
        url_post_import_price
    } from '../../../api/handwork';
    import {
        url_info,
        url_update,
    ...
    export default {
        ...
        computed:{
            // buttons() {
            //     return [
            //         // route:apis.url_add_orders_offline || apis.url_add_orders_reissue || apis.url_add_orders_price
            //         {label: "添加手工订单", value: "add_hand_order",api:this.$hasPermission(url_add_orders_offline) || this.$hasPermission(url_add_orders_reissue) || this.$hasPermission(url_add_orders_price)},
            //         {label: "重新核查", value: "anew_examine",api:true},
            //         {label: "导入手工订单", value: "mport_manual_order",api:this.$hasPermission(url_post_import_offline) || this.$hasPermission(url_post_import_reissue) || this.$hasPermission(url_post_import_price)},
            //     ]
            // },
            shippingPlaceholder() {
        ...
        components: {
            ...
            // addOrder: require('./add-order/index.vue').default,
            // mportOrder: require('./mport-order/index.vue').default,
