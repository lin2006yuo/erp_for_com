...
<script>
    import {api_account_log,url_look_account,url_edit_account,url_token_account,url_account_log} from '@/api/yandex';
        ...
        methods:{
            selects(row){
                ...
                let buttons = [
                    ...
                    {label:is_authorization,value:2, apis:'url_token_account'},
...
//            添加成员事件
            add_member(row){
                ...
                this.api_add_member({channel_id:20,account_id:row.id});
            },
//            添加成员
            api_add_member(val){
