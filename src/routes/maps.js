...
export default {
    ...
    '/goods/goods-tort-description-list': {  //商品-侵权记录页面
        component: Vue.component('product-infringement', function (resolve) {
            require(['../view/product/infringement/index.vue'], resolve);
        })
    },
    '/goods/brand-link':{
        component: Vue.component('goods-delivery',function(resolve){
            require(['../view/product/goods-delivery/index.vue'], resolve);
        })
    },
    '/goods-declare': {
    ...
    '/queue': { ///base/task
        component: Vue.component('base-queue', function (resolve) {
            require(['../view/base/queue-new/index.vue'], resolve);
        })
    },
    ...
    '/department-tag':{//基础设置/权限管理/标签管理
        component:Vue.component('tag-management',function (resolve) {
            require(['../view/base/tag-management/index'],resolve);
        })
    },
    ...
    '/jumia-account': {  ///joom账号
        component: Vue.component('jumia-account', function (resolve) {
            require(['../view/base/account/account-jumia/index.vue'], resolve);
        })
    },
    ...
    '/daraz-account': {  ///base/account/daraz-account Daraz账号
        component: Vue.component('daraz-account', function (resolve) {
            require(['../view/base/account/daraz-account/index.vue'], resolve);
        })
    },
    '/oberlo-account': {  ///base/account/oberlo-account Oberlo账号
        component: Vue.component('oberlo-account', function (resolve) {
            require(['../view/base/account/oberlo-account/index.vue'], resolve);
        })
    },
    '/funmart-account': {  ///base/account/funmart-account Funmart账号
        component: Vue.component('funmart-account', function (resolve) {
            require(['../view/base/account/funmart-account/index.vue'], resolve);
        })
    },
    '/account-basics': {  ///base/account-information
        component: Vue.component('account-basics', function (resolve) {
            require(['../view/base/account-information/index.vue'], resolve);
            // require(['../view/base/base-account/index.vue'], resolve);
        })
    },
    '/register-company': {
        component: Vue.component('register-company', resolve => {
            require(['../view/base/register-company/index.vue'], resolve);
        })
    },
    ...
    '/postoffice': {    ///base/post-management
        component: Vue.component('post-management', function (resolve) {
            require(['../view/base/post-management/index.vue'], resolve);
        })
    },
    ...
    '/phone': {
        /** 手机号管理  -- 临时的路由页面 --待后台接口路由。 */
        component: Vue.component('mobile-management', function (resolve) {
            require(['../view/base/mobile-management/index.vue'], resolve);
        })
    },
    /** 全球国家城市 */
    '/country-area':{
        component: Vue.component("count-list", function (resolve) {
            require(['../view/base/country-city/index.vue'], resolve);
        })
    },
    ...
    /** 财务管理ebay */
    '/ebay-settlement': {
        component: Vue.component('eaby-finance', function (resolve) {
            require(['../view/financial-management/store-capital-accounting/ebay/index.vue'], resolve)
        })
    },
    /** 财务管理Aliexpress */
    '/aliexpress-settlement/index_settle': {
        component: Vue.component('eaby-finance', function (resolve) {
            require(['../view/financial-management/store-capital-accounting/aliexpress/index.vue'], resolve)
        })
    },
    /** 应付款核算  */
    // '/purchase/finance': {
    //     component: Vue.component('purchase-finance', function (resolve) {
    //         require(['../view/financial-management/accounting-payable/index.vue'], resolve)
    //     })
    // },
    // '/ebay/bill':{///ebay月账单
    //     component:Vue.component('eaby-bill',function (resolve) {
    //         require(['../view/financial-management/store-capital-accounting/ebay-bill/index.vue'],resolve)
    //     })
    // },
    // 银行账户
    // '/bank':{
    //     component:Vue.component('bank',function (resolve) {
    //         require(['../view/financial-management/cashier/bank/index.vue'],resolve)
    //     })
    // },
    '/server-network': {
    ...
    '/transfer-fee':{
        component:Vue.component('transporting-charge',function(resolve) {
            require(['../view/base/transporting-charge/index.vue'],resolve);
        })
    },
    ...
    //ebay刊登公用模块
    '/publish-ebay/modules': {
        component: Vue.component('publish-ebay-modules', function (resolve) {
            require(['../view/kandeng/ebay/public-module/index.vue'], resolve);
        })
    },
    //模块组合
    '/publish-ebay/combs': {
        component: Vue.component('publish-ebay-combs', function (resolve) {
    ...
    //BestOffer管理 ebay
    '/ebay/best-offers': {
        component: Vue.component('Publish-EbayCommon-BestOffer', function (resolve) {
            require(['../view/kandeng/ebay/kandeng-best-offer/index.vue'], resolve);
        })
    },
    //刊登风格
    '/publish-ebay/styles': {
        component: Vue.component('publish-ebay-styles', function (resolve) {
            require(['../view/kandeng/ebay/kandeng-style/index.vue'], resolve);
        })
    },
    //促销设置
    '/publish-ebay/promotions': {
        component: Vue.component('publish-ebay-promotions', function (resolve) {
            require(['../view/kandeng/ebay/promotion-set/index.vue'], resolve);
        })
    },
    //自定义分类
    '/publish-ebay/cates': {
        component: Vue.component('publish-ebay-cates', function (resolve) {
    ...
    '/package-carriers': {
        component: Vue.component('packages', function (resolve) {
            require(['../view/entrepot/maintain-information/index.vue'], resolve);
        })
    },
    //Paytm海外仓订单海外仓订单
    '/fbp-orders':{
        component: Vue.component('overseas-paytm-orders', function (resolve) {
            require(['../view/order/paytm-overseas/list/index.vue'], resolve)
        })
    },
    //同步发货状态
    ...
    //报价对比表格
    '/report/shipping-price': { ///entrepot/overseas
        component: Vue.component('shipping-price', function (resolve) {
            require(['../view/entrepot/price-comparsion/index.vue'], resolve);
        })
    },
    ...
    '/shipping-method-large': {
        component: Vue.component('shipping-method-large', function (resolve) {
            require(['../view/entrepot/big-goods-channel-setting/index'], resolve);
        })
    },
    ...
    '/defective-goods-declare': {
        component: Vue.component('defective-goods-declare', function (resolve) {
            require(['../view/entrepot/defective-goods-declare/index.vue'], resolve);
        })
    },
    ...
    '/warehouse-goods/third': {
        component: Vue.component('warehouse-goods', function (resolve) {
            require(['../view/entrepot/warehouse-goods/third/index.vue'], resolve);
        })
    },
    //仓库数据统计
    '/report/unshipped': { //未发货记录
        component: Vue.component('warehouse-data-undelivery', function (resolve) {
            require(['../view/entrepot/warehouse-data/undelivery.vue'], resolve);
        })
    },
    '/report/shortage': { //缺货记录
        component: Vue.component('warehouse-data-stock', function (resolve) {
            require(['../view/entrepot/warehouse-data/no-stock.vue'], resolve);
        })
    },
    '/report/shipped': { //已发货记录
        component: Vue.component('warehouse-data-hasdelivery', function (resolve) {
            require(['../view/entrepot/warehouse-data/has-delivery.vue'], resolve);
        })
    },
    '/report/unpacked': { //未拆包记录
        component: Vue.component('warehouse-data-package', function (resolve) {
            require(['../view/entrepot/warehouse-data/package.vue'], resolve);
        })
    },
    '/report/over-age': { //超库龄
        component: Vue.component('warehouse-data-exceed', function (resolve) {
            require(['../view/entrepot/warehouse-data/exceed.vue'], resolve);
        })
    },
    '/amazon-refund': { //退款明细 amazon
        component: Vue.component('amazon-refund-details', function (resolve) {
            require(['../view/entrepot/amazon-refund-details/index.vue'], resolve);
        })
    },
    '/stocking/apply-list': {
    ...
    '/purchase-return': { // 采购退货管理
        component: Vue.component('purchase-return', function (resolve) {
            require(['../view/entrepot/purchase-return-management/index.vue'], resolve);
        })
    },
    ...
    '/overseas-package-return': { ///海外仓退件
        component: Vue.component('abroad-package-return', function (resolve) {
            require(['../view/entrepot/abroad-package-return/index.vue'], resolve);
        })
    },
    ...
    // '/supplier-rules': { //供应商匹配规则
    //     component: Vue.component('procurement-suppliers-supplier-rules', function (resolve) {
    //         require(['../view/procurement/suppliers/rules/index.vue'], resolve);
    //     })
    // },
    ...
    // '/purchase-return-order': { //退款申请管理
    //     component: Vue.component('procurement-refund', function (resolve) {
    //         require(['../view/procurement/refund/index.vue'], resolve);
    //     })
    // },
    //区域销量分析
    '/report/area-sales-analysis': {
        component: Vue.component('area-analysis', function (resolve) {
            require(['../view/report/area-analysis'], resolve);
        })
    },
    '/report/financial': { //   未动
    ...
    '/report/financial/profit-statement/priceMinister': {  //报表系统priceMinister订单利润明细
        component: Vue.component('report-financial-priceMinister', function (resolve) {
            require(['../view/report/financial/price-minister/index.vue'], resolve);
        })
    },
    '/report/financial/profit-statement/fummart': {  //报表系统fummart订单利润明细
        component: Vue.component('report-financial-fummart', function (resolve) {
            require(['../view/report/financial/fummart/index.vue'], resolve);
        })
    },
    '/report/financial/profit-statement/daraz': {  //报表系统daraz订单利润明细
        component: Vue.component('report-financial-daraz', function (resolve) {
            require(['../view/report/financial/daraz/index.vue'], resolve);
        })
    },
    ...
    '/report/account-operation-analysis': {  ///account-operation-analysis
        component: Vue.component('account-operation-analysis', function (resolve) {
            require(['../view/report/operation-analysis/account-operation-analysis/index'], resolve);
        })
    },
    '/report/lazada-account-report/account': {
        component: Vue.component('lazada-account-site-report', function (resolve) {
            require(['../view/report/lazada-performance-analysis/index'], resolve);
        })
    },
    //商品进销存
    '/invoicing/summary': {
        component: Vue.component('invoicing-summary', function (resolve) {
            require(['../view/report/inventory/index.vue'], resolve);
        })
    },
    '/report/amazon-monitor': {//亚马逊账号监控
    ...
    // '/work-order': {
    //     component: Vue.component('work-order-progress', function (resolve) {
    //         require(['../view/work-order-management/work-order-management/work-order-process/index.vue'], resolve)
    //     })
    // },
    // '/work-order/self': {
    //     component: Vue.component('work-order-self', function (resolve) {
    //         require(['../view/work-order-management/work-order-management/my-work-order/index.vue'], resolve)
    //     })
    // },
    // '/work-order/problem-types': {
    //     component: Vue.component('problem-type-management', function (resolve) {
    //         require(['../view/work-order-management/problem-type-management/index.vue'], resolve)
    //     })
    // },
    ...
    '/virtual-tracking': {//----虚拟跟踪号
        component: Vue.component("virtual-tracking", function (resolve) {
            require(["../view/virtual-order/virtual-trace-number/index.vue"], resolve)
        })
    },
    ...
    // '/wait-return-to-shelves': {
    //     component: Vue.component('wait-return-to-shelves', function (resolve) {
    //         require(['../view/entrepot/warehouse-goods/wait-return-to-shelves/index.vue'], resolve)
    //     })
    // },
    ...
    '/daraz-orders': {//daraz订单
        component: Vue.component('daraz-orders', function (resolve) {
            require(['../view/order/daraz-orders/list/index.vue'], resolve)
        })
    },
    '/funmart-orders':{//Funmart平台
        component: Vue.component('funmart-orders', function (resolve) {
            require(['../view/order/funmart-orders/list/index.vue'], resolve)
        })
    },
    '/oberlo-orders': {//oberlo订单
        component: Vue.component('oberlo-orders', function (resolve) {
            require(['../view/order/oberlo-orders/list/index.vue'], resolve)
        })
    },
    '/vova-orders': {
    ...
    // '/timeout-penalty/unpack-abnormal': {
    //     component: Vue.component('timeout-penalty-unpack-abnormal', function (resolve) {
    //         require(['../view/report/fine-report/unpacking-abnormal-timeout/index.vue'], resolve)
    //     })
    // },
    ...
    '/purchase-order-ali1688': {//阿里最迟付款时间
        component: Vue.component('purchase-order-ali1688', function (resolve) {
            require(['../view/procurement/ali-last-pay-time/index.vue'], resolve)
        })
    },
    //虚拟付款申请
    ...
    '/keywords-manage': {//关键词管理
        component: Vue.component('keywords-manage', function (resolve) {
            require(['../view/customer-service/keywords-manage/management/index.vue'], resolve)
        })
    },
    '/keywords-list': {//关键词抓取记录
        component: Vue.component('keywords-manage', function (resolve) {
            require(['../view/customer-service/keywords-manage/record/index.vue'], resolve)
        })
    },
    '/stocking-advice': {
    ...
    // '/purchase-parcels/capacity-input': {
    //     component: Vue.component('capacity-input', function (resolve) {
    //         require(['../view/entrepot/package/capacity-input/index.vue'], resolve)
    //     })
    // },
    ...
    '/local-stocking': {
        component: Vue.component('local-stocking', function (resolve) {
            require(['../view/entrepot/stocking/activity/index.vue'], resolve);
        })
    },
    '/purchase-order/return-of-goods-purchase': {
        component: Vue.component('parcel-return-list', function (resolve) {
            require(['../view/procurement/parcel-return-list/index.vue'], resolve);
        })
    },
    '/email': {  ///邮箱管理
        component: Vue.component('email', function (resolve) {
            require(['../view/base/email/index.vue'], resolve);
        })
    },
    '/credit-card': {  ///信用卡管理
        component: Vue.component('credit-card', function (resolve) {
            require(['../view/base/finance-management/credit-card/index.vue'], resolve);
        })
    },
    '/paypal-account': {  ///base/finance-management/paypal
        component: Vue.component('base-finance-management-paypal', function (resolve) {
            require(['../view/base/finance-management/paypal/index.vue'], resolve);
        })
    },
    '/pingpong': {  ///base/finance-management/pingpong
        component: Vue.component('base-finance-management-pingpong', function (resolve) {
            require(['../view/base/finance-management/pingpong/index.vue'], resolve);
        })
    },
    '/lianlianpay': {  ///base/finance-management/lianlianpay
        component: Vue.component('base-finance-management-lianlianpay', function (resolve) {
            require(['../view/base/finance-management/lianlianpay/index.vue'], resolve);
        })
    },
    '/payoneer': {  ///base/finance-management/payoneer
        component: Vue.component('base-finance-management-payoneer', function (resolve) {
            require(['../view/base/finance-management/payoneer/index.vue'], resolve);
        })
    },
    '/worldfirst': {  ///base/finance-management/paypal
        component: Vue.component('base-finance-management-worldfirst', function (resolve) {
            require(['../view/base/finance-management/worldfirst/index.vue'], resolve);
        })
    },
    '/purchase-parcels/return-of-goods-warehouse': {
        component: Vue.component('return-of-goods-warehouse', function (resolve) {
            require(['../view/entrepot/package/return/index.vue'], resolve);
        })
    },
    '/goods-discount':{ // 商品管理 》补贴列表
        component:Vue.component('subsidized-list',function(resolve){
            require(['../view/product/subsidized-list/index.vue'],resolve)
        })
    },
    '/overseas-pandao-orders':{
        component: Vue.component('overseas-pandao-orders', function (resolve) {
            require(['../view/order/my-mall-overseas/list/index.vue'], resolve);
        })
    },
    '/wish-message': {
        component: Vue.component('customer-service-wish-letter-outbox', function (resolve) {
            require(['../view/customer-service/wish-letter/inbox/index.vue'], resolve)
        })
    },
    '/wish-outbox': {
        component: Vue.component('customer-service-wish-letter-outbox', function (resolve) {
            require(['../view/customer-service/wish-letter/outbox/index.vue'], resolve)
        })
    },
    '/wish-time-setting': { ///customer-service/smt/outbox
        component: Vue.component('customer-service-wish-time-setting', function (resolve) {
            require(['../view/customer-service/wish-letter/time-setting/index.vue'], resolve)
        })
    },
    // ebay账号表现
    '/ebay/account-performance':{
        component: Vue.component('account-performance', function (resolve) {
            require(['../view/kandeng/ebay/account-performance/index.vue'], resolve);
        })
    },
    // ebay账号表现详情
    '/account-listing':{
        realPath: '/account-listing',
        component: Vue.component('account-listing', function (resolve) {
            require(['../view/kandeng/ebay/account-performance/account-listing.vue'], resolve);
        })
    },
    // '/sample':{
    //     component:Vue.component('be-plan',function(resolve){
    //         require(['../view/product/specimen/be-plan/index.vue'],resolve)
    //     })
    // },
    // '/godown-entry':{
    //     component:Vue.component('godown-entry',function(resolve){
    //         require(['../view/product/specimen/godown-entry/index.vue'],resolve)
    //     })
    // },
    // '/package-return-rules':{
    //     component:Vue.component('base-package-return-rules',function (resolve) {
    //         require(['../view/base/package-return-rules/index.vue'],resolve)
    //     })
    // }
    /*'/lazada-listing-manage':{  // lazada平台 listing管理
        component:Vue.component('listing-manage',function(resolve){
            require(['../view/kandeng/lazada/list/listing-manage.vue'], resolve);
        })
    },
    '/lazada-selection-publish':{ // lazada平台 选品刊登
        component:Vue.component('selection-publish',function(resolve){
            require(['../view/kandeng/lazada/list/index.vue',],resolve)
        })
    },
    '/kandeng/lazada/info':{    // lazada刊登详情
        component:Vue.component("lazada-info",function(resolve){
            require(["../view/kandeng/lazada/info/index.vue"],resolve)
        })
    }*/
};
