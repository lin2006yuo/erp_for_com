        ...
        <div class="p-head-border-color">
            ...
            <table style="width: 100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <th width="80px" class="required-sign">报关价($)</th>
                ...
                <tr>
                    ...
                    <!--报关价($)-->
                    <td>
                        <el-input class="inline" v-model="declared_value" @blur="batch(declared_value,'declared_value')"></el-input>
                    </td>
                    <!--数量-->
                    <td>
                ...
                <tr v-for="(row, index) in accountInfo.variant" :key="index">
                    ...
                    <!--报关价($)-->
                    <td >
                        <el-input v-model="row.declared_value"></el-input>
                    </td>
                    <!--数量-->
                    <td>
    ...
    export default{
        data(){
            return {
                ...
                temp:{},
                declared_value:'',
                bool:!!this.accountInfo.variant[0].declared_value
            }
        },
        created(){
