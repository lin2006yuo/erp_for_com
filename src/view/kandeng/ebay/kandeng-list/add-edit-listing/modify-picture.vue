        ...
        <page-dialog title="已选中图片" v-model="visible" size="large" :close-on-click-modal="false" class="receive-search">
            <el-popover
                ...
                <div>
                    ...
                    <el-button type="primary" size="mini" @click="add_url">{{$t('common.confirm')}}</el-button>
                </div>
                <span slot="reference" >
            ...
            <div slot="footer" class="dialog-footer mt-md">
                <el-button @click.native="sure" type="primary" size="mini">{{$t('common.confirm')}}</el-button>
                <el-button @click.native="visible = false" size="mini">{{$t('common.cancel')}}</el-button>
            </div>
        </page-dialog>
    </div>
</template>
