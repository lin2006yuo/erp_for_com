<template>
    <search-card @search="search" @enter="search" :params="paramList" :clears="clears">
        <el-select v-sf.snType
                   ...
                   class="inline mb-mini s-width-small" >
        ...
        <label-item label="上传时间：" class="mr-sm mb-mini ">
            <el-date-picker class="inline date mb-mini s-width-default" v-sf.start_time
                            v-model="paramList.start_time" type="date" style="width: 120px;"
                            :picker-options="pickerstart" placeholder="开始时间"></el-date-picker>
          <span>&nbsp;&nbsp; -- &nbsp;&nbsp;</span>
            <el-date-picker class="inline date mb-mini s-width-default" v-sf.end_time
                            v-model="paramList.end_time" type="date" style="width: 120px;"
...
<script>
    ...
    import {api_get_myMall} from '../../../../api/mymall'
    export default{
		data(){
			return {
                pickerstart:{
