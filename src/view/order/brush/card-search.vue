        ...
        <search-card @search="search" :params="form" :clears="clears">
            <el-row class="mb-mini">
                ...
                <label-item label="账号简称：" class="ml-sm">
                    ...
                    ></super-select>
                    <!--<el-select :disabled="accoutOptions.length<=1"                   旧版-->
                               <!--filterable clearable-->
                               <!--:placeholder="accountPlaceholder"-->
                               <!--v-sf.account_id-->
                               <!--class="s-width-small"-->
    ...
    export default {
        ...
        watch: {
            "form.channel_id"(channel_id) {
                ...
                this.siteOptions = [];
                this.accoutOptions = [];
                this.get_account_site(channel_id);
            },
            "form.site"(site) {
                this.form.account_id = "";
                this.accoutOptions = [{label: "", value: ""}];
                this.get_account_site(this.form.channel_id,site);
            },
            'form.account_id'() {
        ...
        methods:{
            ...
            get_account_site(channel_id,site){
                if(!channel_id){
                    this.accoutOptions = [];
                    this.siteOptions = [];
                    return
