    ...
    <page class="c-show-message">
        <div>
                    ...
                    <div>
                        <template v-if="row.listing_status===4">
                            ...
                            <el-popover placement="left"
                                        ...
                                        width="400"
                                        trigger="hover">
                                <div class="word-wrap" v-html="delHtml(row.message)" v-if="putMes(row.message)"></div>
                                <div class="word-wrap" v-else>{{row.message}}</div>
                                <span slot="reference">
            ...
            <el-button type="primary"
                       ...
                       @click.native="close">{{$t('common.close')}}</el-button>
