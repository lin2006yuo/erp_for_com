...
<script>
import {api_save_combList} from '../../../../api/ebay-kandeng-public-module';
    export default{
        data(){
            return {
                dialog:false,
            ...
            save(){
                this.$refs.form.validate((bool)=>{
                    if(bool){
                        ...
                        curForm.promotion_discount=curForm.promotion_discount?curForm.promotion_discount:'0.00';
                        curForm.promotion_cash=curForm.promotion_cash?curForm.promotion_cash:'0.00';
                        curForm.promotion_trans = curForm.promotion_trans?1:0;
                        curForm.promotion = curForm.promotion?1:0;
                        let params = {
                            type:"promotion",
                            detail:JSON.stringify(curForm)
                        };
