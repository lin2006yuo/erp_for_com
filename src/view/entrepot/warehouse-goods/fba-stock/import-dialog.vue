<template>
    <page-dialog class="p-import-excel" title="导入SKU" v-model="visible" size="large" :close-on-click-modal="false">
        <div>
            <div class="file-btn">
                选取文件
...
<script>
    import {api_post_import_sku} from '@/api/fba-stock.js';
