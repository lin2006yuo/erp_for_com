...
//批量转交拣货单
export const url_batch_pickings_shipper = "post|pickings/batch/shipper";
export const api_batch_pickings_shipper = function (data) {
    return http(url_batch_pickings_shipper, data)
};
