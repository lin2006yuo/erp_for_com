...
<script>
    import {url_get_shopee_account,api_account_log,
        url_post_shopee_change,url_shopee_permit,url_account_log} from '@/api/shopee';
    import {api_add_member,url_add_member} from '@/api/aliexpress';
    export default{
        permission:{
            url_get_shopee_account,
            url_post_shopee_change,
            url_shopee_permit,
            url_account_log,
            url_add_member
        },
        ...
        methods:{
            selects(row){
                ...
                let buttons = [
                    {label:'查看',value:0, apis:'url_get_shopee_account'},
                    {label:'编辑',value:1, apis:'url_post_shopee_change'},
                    {label:is_authorization,value:2, apis:'url_shopee_permit'},
...
//            添加成员事件
            add_member(row){
                ...
                this.api_add_member({channel_id:9,account_id:row.id});
            },
//            添加成员
            api_add_member(val){
