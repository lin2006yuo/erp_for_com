                ...
                <div>
                    <permission
                        tag="span"
                            class="operate"
                            @click="edit(row)"
                            :route="apis.url_save_combList">编辑</permission>
...
<script>
    import {api_get_combList,api_edit_combList,api_delete_promotion} from '../../../../api/ebay-kandeng-public-module';
