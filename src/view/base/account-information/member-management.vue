                    ...
                    <el-row>
                        <el-col :span="16">
                            ...
                            <el-input v-model="searchData.searchVal"
                                      ...
                                      class="ml-xs inline"
                                      icon="search">
                                <!--:icon="searchData.searchVal?'close':'search'"-->
...
//            ----------------------------------  点击添加  变为红色字体
            ...
            uniqueArray(array, key){
                ...
                console.log(result,777777777,this.currentUser);
                return result;
            },
            check(item){
                console.log(item,'check single',item.check);
                console.log(this.dataList,this.parentsList,this.leaderList);
                if(item.check){
...
//            ------------------------------------  可添加列表  添加
            ...
            check_all(bool){
                console.log(bool,'check_all',this.newAdd);
