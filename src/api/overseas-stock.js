...
//同步第三方仓价格
export const url_sync_third_price = "post|warehouse-goods/third-sync-price";
export const api_sync_third_price = function (data) {
    return http(url_sync_third_price, data)
}