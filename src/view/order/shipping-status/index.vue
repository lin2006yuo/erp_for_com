            ...
            <search-card @search="search"
                ...
                <div>
                    ...
                    <super-select
                        ...
                        v-sf.site_id class="inline width-sm"
                ...
                <div>
                    ...
                    <label-item class="mr-sm ml-mini" label="上传跟踪号类型：">
                        <el-select v-sf.shipping_type
                                   class="inline s-width-small"
                                   v-model="searchData.shipping_type"
                                   clearable>
                            <el-option v-for="(item, index) in trackingTypeOptions"
                                       :label="item.label"
                                       :key="index"
                                       :value="item.value">
                            </el-option>
                    ...
                    <label-item class="mr-sm" label="是否有跟踪号：">
                        <el-select v-sf.shipping_has
                                   class="inline s-width-mini"
                                   v-model="searchData.shipping_has"
                                   clearable>
                            <el-option v-for="(item, index) in trackingOptions"
                                       :label="item.label"
                                       :key="index"
                                       :value="item.value">
                            </el-option>
                ...
                <el-row>
                    <label-item class="mb-mini" label="同步状态：">
                ...
                <order-input class="inline width-super pt-sm"
                             ...
                             v-if="searchData.snType==='number'||searchData.snType==='package_number'||searchData.snType==='shipping_number'||searchData.snType==='channel_order_number'||searchData.snType==='intercept_tracking'"
                             @keydown="search"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                connds: [
                    ...
                    {label: '同步平台跟踪号', value: 'intercept_tracking'}
                ],
                countryList: [],
                warehouseList: [],
                tablePg: {
        ...
        computed: {
            isAliExpress(){
                return this.searchData.channel_id===1||this.searchData.channel_id===3||this.searchData.channel_id===4||this.searchData.channel_id===12
            },
            changeLabel() {
