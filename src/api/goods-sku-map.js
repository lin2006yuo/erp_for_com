...
export const url_get_account = 'get|sku-map/account';
export const api_get_account = function (data) {
    return http(url_get_account,data);
};
//sku-map/employee
export const url_sku_map_employee = 'get|sku-map/employee';
export const api_sku_map_employee = function (data) {
    return http(url_sku_map_employee,data);
};
//商品映射 sku 日志

export const url_sku_map_log = 'get|sku-map/:id/logs';
export const api_sku_map_log = function(id){
    return http(Url2(url_sku_map_log,{id:id}))
}
