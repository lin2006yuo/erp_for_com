...
//获取导出字段
export const url_get_export_title = "get|warehouse-goods-check/export-title";
export const api_get_export_title = function(){
    return http(url_get_export_title);
};

//导出
export const url_post_export = "post|warehouse-goods-check/export";
export const api_post_export = function(data,head){
    return http(url_post_export,data,head)
};
...
//异常数据追责导出
export const url_post_abnormal_export = "post|warehouse-goods-check/abnormal-export";
export const api_post_abnormal_export = function(data){
    return http(url_post_abnormal_export,data)
};
