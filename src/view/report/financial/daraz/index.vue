<template>
    <page class="channel-profit">
        <search-module @init-data="init_data" ref="search_module" :channel-id="32"></search-module>
...
<script>
    import {api_report_daraz} from  '@/api/report-channel'
