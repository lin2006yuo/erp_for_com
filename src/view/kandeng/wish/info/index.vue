    ...
    <page class="p-index-wish-publish over-flow-auto">
        ...
        <div class="page-fixed mt-lg">
            ...
            <el-button size="mini"
                       ...
                       type="primary"
                       :disabled="isSubmit"
                       @click.native="isTort" >提交刊登</el-button>
            <el-button size="mini"
                       v-if="!isAdd"
                       type="primary"
                       class="p-wish-btn"
                       :disabled="isSubmit||is_tort"
                       @click.native="isTort">提交刊登</el-button>
            <el-button size="mini"
                       class="p-wish-btn"
...
//                复制
        ...
        methods:{
            ...
            isTort(){
                ...
                this.goods_description(data);
            },
            goods_description(data){
                if((typeof data==="object")&&this.param.tort_flag===1){
                    this.tortShow = true;
