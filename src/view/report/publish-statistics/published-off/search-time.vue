    ...
    <div class="spu-publish">
        <search-card :params="searchData" :clears="clears" @search="search" >
            ...
            <label-item label="销售员：" class="mt-mini mb-mini">
                ...
                <!--<super-select-->
                    <!--:storage-key="seller_m"-->
                    <!--:options="sellerMixinOptions"-->
                    <!--v-model="searchData.shelf_name"-->
                <!--&gt;</super-select>-->
            </label-item>
            <label-item label="下架数量范围：" class="ml-sm">
                <input type="number" v-model="searchData.min_num"  @blur="handle_keyup_min" class="number width-mini" v-range.number min="0" >
                <span>&nbsp;--&nbsp;</span>
                <input type="number" v-model="searchData.max_num"  @blur="handle_keyup_max" class="number width-mini" v-range.number min="0" >
            </label-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handle_keyup_max(e) {
                const value = e.target.value;
                if(+value < +this.searchData.min_num && this.searchData.max_num !== "") {
                    console.log('***')
