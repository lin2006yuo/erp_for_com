        ...
        >
            ...
            <template v-for="(order,index) in tableData">
                <tr>
                    ...
                    >
                        <plus-minus v-if="index === 0" @show-detail="show(index, order)" :show="order.show" :title="tipTitle"></plus-minus>
                        <ui-tip :content="handle_data(order, item)" ></ui-tip>
                    </td>
...
//        	时间转换
        ...
        methods: {
            init(){
                ...
                this.$http(this.apiTableData, data).then(res=>{
                    this.loading = false;
