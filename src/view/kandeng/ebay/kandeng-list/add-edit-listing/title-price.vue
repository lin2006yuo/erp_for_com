        ...
        <div v-if="whichPage===0">
            <rainbow-header title="标题与价格（拍卖）" backgroundColor="#F18700">
                <el-form :model="form" label-width="220px" ref="form" :rules="rules">
                        ...
                        <el-form-item :label="$t('ebay-list.cxsetting')" v-if="!isEdit">
                            <el-row :gutter="8">
                                <el-col :span="commonSpan">
                ...
                <el-form :model="form" label-width="220px" ref="form" :rules="rules">
                    ...
                    <!--<el-form-item label="接受买家还价(Best Offer)：" required>-->
                        <!--<el-radio-group v-model="form.list.best_offer" @change="change_best_offer">-->
                            <!--<el-radio class="inline"  :label="0">{{$t('common.close')}}</el-radio>-->
                            <!--<el-radio class="inline ml-lg" :label="1">{{$t('common.open')}}</el-radio>-->
                        <!--</el-radio-group>-->
                    <!--</el-form-item>-->
                    <!--<el-form-item>-->
                        <!--<el-checkbox-group>-->
...
<script>
import {api_pricing_rules,api_get_combList} from '../../../../../api/ebay-kandeng-public-module';
...
//                }
        ...
        mounted(){
            this.form.set.auto_accept_price= this.form.set.auto_accept_price==='0.00'?'':this.form.set.auto_accept_price;
            this.form.set.minimum_accept_price= this.form.set.minimum_accept_price==='0.00'?'':this.form.set.minimum_accept_price;
        ...
        methods:{
            ...
            //促销折扣数据
            get_promotion(){
                this.$http(api_get_combList,{type:"promotion",accountId:this.accountId,status:1}).then(res=>{
