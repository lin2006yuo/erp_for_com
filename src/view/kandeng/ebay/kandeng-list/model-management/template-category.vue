<template>
    <page-dialog v-model="show" size="small" title="修改范本分类" @open="open"
        ...
        <div slot="footer" class="dialog-footer">
            <request-button @click="keep" req-key="templateCategory" :mintime="300">{{$t('common.confirm')}}</request-button>
...
<script>
    import {api_get_combList,api_up_draft_cate} from '../../../../../api/ebay-kandeng-public-module';
    export default{
        data(){
            return{
                show:this.value,
