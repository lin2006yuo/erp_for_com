...
<script >
    import {api_save_combList,api_save_common_trans,api_get_transform} from '../../../../api/ebay-kandeng-public-module';
    ...
    export default{
        ...
        methods:{
            ...
            open(){
                ...
                this.curSite.name = "";
                this.curSite.symbol = "";
                console.log(this.form.trans,'trans')
            },
            ...
            init_form(){
                ...
                this.$set(this.form,'minimum_feedback',"");
...
//                            {inter:1,trans_code:"",cost:"",add_cost:"",extra_cost:"",is_all_location:false,location:this.get_local(this.locationList)},
            ...
            add_in_transport(){
                ...
                let cur_code = this.inlandList.length>0?this.inlandList[length-1].trans_code:true;
...
//                                        site:this.form.site,
                                ...
                                case "refuse":
                                    ...
                                    obj = {
                                        ...
                                        minimum_feedback: this.form.minimum_feedback,
                            ...
                            curTrans.forEach(row=>{
                                ...
                                if(row.extra_cost===''){row.extra_cost='0.00'}
                                if(!!row.trans_code){
                                    curTransList.push(row);
                                }
                                if(row.location.length===this.get_local(this.locationList).length) {
                                    row.location = ["Worldwide"];
                                }
                            });
                            ...
                            delete data.action;
                            data.detail = obj;
                            return this.$http(api_save_combList,data).then(res=>{
