            ...
            <tr style="background-color: #d6e9c6">
                <td colspan="16">
                    <div class="inline fl mt-xs mb-xs">
                        <label-item  class="ml-sm inline mr-sm">
                            <span style="color:red;">*</span>
                            <span>{{$t('ymx-up-lower-rule.displayDate')+'：'}}</span>
                        ...
                        <label-item class="inline mr-sm">
                            <span style="color:red;">*</span>
                            <span>{{$t('ymx-up-lower-rule.removeDate')+'：'}}</span>
    ...
    export default {
        ...
        methods: {
            ...
            sure(row) {//确定
                ...
                // if(this.up_value && this.lower_value) {
                ...
                // }else{
                //          this.$message({type:'error',message:"上架时间和下架时间不能为空"});
                //      }
            },
            data_picker_b(val){
