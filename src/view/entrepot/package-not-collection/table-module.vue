        ...
        <mailing-method ref="mailing" @left-show-change="left_show_change">
            ...
            <el-table
                ...
                <el-table-column
                    ...
                    min-width="120"
                    inline-template>
                    <div v-if="row.providers_shipping_time" :class="add_exception(row.in_exception)">
                        <ui-tip :content="row.providers_shipping_time | filterTime" :width="98"></ui-tip>
                    </div>
                    <div v-else :class="add_exception(row.in_exception)">
                        <ui-tip content="未上线" :width="98"></ui-tip>
                    </div>
                </el-table-column>
                <el-table-column
                        label="操作"
