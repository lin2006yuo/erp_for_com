            ...
            <el-form :model="addEditData" :rules="rules" ref="addEditData" label-width="160px">
                ...
                <el-form-item label="简称：">
                    <el-col :span="spanWidth">
                        <el-input v-model="addEditData.code"
                                  v-if="curPage!=='lookOver'" disabled></el-input>
                ...
                <el-form-item label="抓取wish订单功能：">
                    <el-col :span="spanWidth">
                        ...
                        <span v-else>{{addEditData.download_order | filterHour}}</span>
                    </el-col>
                </el-form-item>
                <el-form-item label="同步发货状态到wish功能：">
                    <el-col :span="spanWidth">
                        ...
                        <span v-else>{{addEditData.sync_delivery | filterHour}}</span>
                    </el-col>
                </el-form-item>
...
<script>
    ...
    import {wish_update} from '@/api/wish';
