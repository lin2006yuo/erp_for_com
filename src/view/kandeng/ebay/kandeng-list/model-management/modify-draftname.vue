<template>
    <page-dialog title="批量修改范本名称" v-model="dialog" @open="open"
        ...
        >
            ...
            <!--</el-table-column>-->
            <el-table-column label="SPU" inline-template width="250">
                <ui-tip :content="row.spu" ></ui-tip>
            </el-table-column>
            <el-table-column :label="$t('ebay-list.TemplateName')" inline-template>
        ...
        <div slot="footer">
            <request-button class="inline" :disabled="canUse" reqKey=""
                            @click.native="submit">{{$t('common.confirm')}}</request-button>
