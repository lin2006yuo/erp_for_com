...
// };
export const url_getSupplier = "get|purchase-plan/getSupplier";
export const api_getSupplier = function(data) {
    return http(Url2(url_getSupplier),data);
};
//到货列表
...
//退货单详情
export const url_get_look_details = "get|purchase-return-order/:id/return-form";
...
//修改优惠金额
export const url_purchase_discount_amount = "put|purchase-order/:id/discount-amount";
export const api_purchase_discount_amount = function (id, data) {
    return http(Url2(url_purchase_discount_amount, {id: id}), data)
};
//修改实际金额
export const url_purchase_actual_shipping_cost = "put|purchase-order/:id/actual-shipping-cost";
export const api_purchase_actual_shipping_cost = function (id, data) {
    return http(Url2(url_purchase_actual_shipping_cost, {id: id}), data)
};
//操作日志
export const url_purchase_order_log= "get|purchase-order/getLogDetail";
export const api_purchase_order_log  = function(data) {
    return http(Url2(url_purchase_order_log), data);
};
//审核人
export const url_get_username_list = "get|user/usernameList";
export const api_get_username_list = function(data) {
    return http(Url2(url_get_username_list), data);
};
