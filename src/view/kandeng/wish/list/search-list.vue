        ...
        <search-card @search="search" :params="searchData" :clears="clears">
            <div class="mb-mini">
                ...
                <div class="inline width-sm">
                    <super-select v-model="searchData.accountVal"
                                  v-sf.accountVal
            ...
            <div class="inline width-xs" >
                <super-select v-model="searchData.uid"
                              v-sf.uid
                              storageKey="wish-uid"
                              :options="sellerList">
                </super-select>
            ...
            <label-item label="是否虚拟仓发货：">
                <el-select
                    v-model="searchData.is_virtual_send"
                    class="inline width-sm">
                    <el-option
            ...
            <label-item label="重量范围："  class="mr-md " style="margin-top:3px;">
                <div class="inline">
                    <el-input v-model="searchData.min_weight" type="number" min="0" class="inline" placeholder="最小重量值"></el-input>
                    <span>~</span>
                    <el-input v-model="searchData.max_weight" type="number" min="0" class="inline" placeholder="最大重量值"></el-input>
                </div>
            </label-item>
            <label-item label="侵权平台：">
                <el-select
