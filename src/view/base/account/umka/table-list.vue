...
<script>
    import {api_account_log,url_umka_look,url_umka_edit,url_umka_token,url_account_log} from '@/api/Umka-account';
    ...
    export default {
        ...
        methods:{
            selects(row){
                ...
                let buttons = [
                    {label:'查看',value:0, apis:'url_umka_look'},
                    {label:'编辑',value:1, apis:'url_umka_edit'},
                    {label:is_authorization,value:2, apis:'url_umka_token'},
...
//            添加成员事件
            add_member(row){
                ...
                this.api_add_member({channel_id:14,account_id:row.id});
            },
//            添加成员
            api_add_member(val){
