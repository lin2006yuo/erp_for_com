    ...
    <page class="p-base-info">
        <el-form ref="form1" :rules="rules" :model="baseData" label-width="180px">
            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item label="跟踪号：">
                        ...
                        <div class="inline" style="margin-left:30px;display:inline-block;"> 获取跟踪方式：
                ...
                <el-col :span="12">
                    <el-form-item label="结算方式：">
                        <el-select v-model="baseData.settlement_method"
                                   class="width-lg"
                        ...
                        <tr>
                            ...
                            <td v-for="(col,col_i) in cols" style="padding: 3px " :key="col_i">
                                ...
                                <div v-if="item.info[col-1]&&item.info[col-1].type==='select'" class="inline width-lg">
                                    <super-select v-model="item.info[col-1].value"
                                                  :storageKey="item.info[col-1].url"
                                                  :options="item.info[col-1].selects"
                                                  :disabled="!editable"></super-select>
            ...
            <el-form-item label="爬虫物流轨迹：">
                <div>
                    <el-radio class="radio" v-model="baseData.push_reptile " :label="0" :disabled="!editable">不推送
                    </el-radio>
                    <el-radio class="radio" v-model="baseData.push_reptile " :label="1" :disabled="!editable">推送到钮门
                    </el-radio>
                    <el-radio class="radio" v-model="baseData.push_reptile " :label="2" :disabled="!editable">推送到17
                    </el-radio>
                </div>
            </el-form-item>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="name：" prop="sender_name" required>
                            <ui-input v-model="baseData.sender_name" class="inline"
                                      :edit="editable && hasSender"></ui-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="Company：" prop="sender_company" required>
                            <ui-input v-model="baseData.sender_company" class="inline"
                                      :edit="editable && hasSender"></ui-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="Country：" prop="sender_country" required>
                            <ui-input v-model="baseData.sender_country" class="inline"
                                      :edit="editable && hasSender"></ui-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="State：" prop="sender_state" required>
                            <ui-input v-model="baseData.sender_state" class="inline"
                                      :edit="editable && hasSender"></ui-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="City：" prop="sender_city" required>
                            <ui-input v-model="baseData.sender_city" class="inline"
                                      :edit="editable && hasSender"></ui-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="Distric：" prop="sender_district" required>
                            <ui-input v-model="baseData.sender_district" class="inline"
                                      :edit="editable && hasSender"></ui-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="Zip Code：" prop="sender_zipcode" required>
                            <ui-input v-model="baseData.sender_zipcode" class="inline"
                                      :edit="editable && hasSender"></ui-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="Email：" prop="sender_email" required>
                            <ui-input v-model="baseData.sender_email" class="inline"
                                      :edit="editable && hasSender"></ui-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="揽收人名称：" prop="pickup_name" required>
                            <ui-input v-model="baseData.pickup_name" class="inline"
                                      :edit="editable && hasPickup"></ui-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="揽收人公司：" prop="pickup_company" required>
                            <ui-input v-model="baseData.pickup_company" class="inline"
                                      :edit="editable && hasPickup"></ui-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="揽收人国家：" prop="pickup_country" required>
                            <ui-input v-model="baseData.pickup_country" class="inline"
                                      :edit="editable && hasPickup"></ui-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="揽收人省/州：" prop="pickup_state" required>
                            <ui-input v-model="baseData.pickup_state" class="inline"
                                      :edit="editable && hasPickup"></ui-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="揽收人城市：" prop="pickup_city" required>
                            <ui-input v-model="baseData.pickup_city" class="inline"
                                      :edit="editable && hasPickup"></ui-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="揽收人行政区：" prop="pickup_district" required>
                            <ui-input v-model="baseData.pickup_district" class="inline"
                                      :edit="editable && hasPickup"></ui-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="揽收人街道：" prop="pickup_street" required>
                            <ui-input v-model="baseData.pickup_street" class="inline"
                                      :edit="editable && hasPickup"></ui-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="揽收人邮箱：" prop="pickup_email" required>
                            <ui-input v-model="baseData.pickup_email" class="inline"
                                      :edit="editable && hasPickup"></ui-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="退货联系人名称：" prop="return_name" required>
                            <ui-input v-model="baseData.return_name" class="inline"
                                      :edit="editable && hasReturn"></ui-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="退货联系人公司：" prop="return_company" required>
                            <ui-input v-model="baseData.return_company" class="inline"
                                      :edit="editable && hasReturn"></ui-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="退货联系人国家：" prop="return_country" required>
                            <ui-input v-model="baseData.return_country" class="inline"
                                      :edit="editable && hasReturn"></ui-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="退货联系人省/州：" prop="return_province" required>
                            <ui-input v-model="baseData.return_province" class="inline"
                                      :edit="editable && hasReturn"></ui-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="退货联系人城市：" prop="return_city" required>
                            <ui-input v-model="baseData.return_city" class="inline"
                                      :edit="editable && hasReturn"></ui-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="退货联系人区：" prop="return_district" required>
                            <ui-input v-model="baseData.return_district" class="inline"
                                      :edit="editable && hasReturn"></ui-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="退货联系人街道：" prop="return_street" required>
                            <ui-input v-model="baseData.return_street" class="inline"
                                      :edit="editable && hasReturn"></ui-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="退货联系人邮箱：" prop="return_email" required>
                            <ui-input v-model="baseData.return_email" class="inline"
                                      :edit="editable && hasReturn"></ui-input>
                        </el-form-item>
                    </el-col>
                </el-row>
...
<script>
    ...
    import {api_get_settlement} from "@/api/setLogistics";
    ...
    export default {
        ...
        methods: {
            ...
            //获取结算方式
            get_settlement() {
                this.$http(api_get_settlement).then(res => {
