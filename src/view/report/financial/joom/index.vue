<template>
    <page class="channel-profit">
        <search-module @init-data="init_data" ref="search_module" :channel-id="7"></search-module>
        <request-button
                :disabled="hasData"
...
<script>
    import {api_report_joom} from  '../../../../api/report-channel'
        ...
        data(){
            return{
                ...
                header: [
                    ...
                    {label:'店铺简称',size:100, value: 'account_code'},
