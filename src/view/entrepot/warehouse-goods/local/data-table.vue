                    ...
                    <tr :key="row.id">
                        ...
                        <td>
                            <el-popover placement="bottom"
                                        ref="use_quantity"
                                        @show="show_lock_stock(row.sku_id)"
                                        trigger="click"
                                        width="400">
                                <el-table :data="stockLockDetail"
                                          max-height="250"
                                          class="scroll-bar">
                                    <el-table-column width="130" label="活动备货单号" prop="number"></el-table-column>
                                    <el-table-column width="100" label="平台" prop="channel_name"></el-table-column>
                                    <el-table-column width="70" label="锁定数" prop="lock_quantity"></el-table-column>
                                    <el-table-column width="100" label="活动开始时间" prop="start_time"></el-table-column>
                                </el-table>
                                <span slot="reference" class="operate">{{row.ready_lock_quantity}}</span>
                            </el-popover>
                        </td>
                        <!-- 活动备货数 -->
                        <td>
                            <el-popover placement="bottom"
                                        ref="stock_quantity"
                                        @show="show_stock(row.sku_id)"
                                        trigger="click"
                                        width="500">
                                <el-table :data="stockDetail"
                                          max-height="250"
                                          class="scroll-bar">
                                    <el-table-column width="130" label="活动备货单号" prop="number"></el-table-column>
                                    <el-table-column width="100" label="平台" prop="channel_name"></el-table-column>
                                    <el-table-column width="70" label="备货数" prop="stock_quantity"></el-table-column>
                                    <el-table-column width="100" label="锁定数" prop="bind_quantity"></el-table-column>
                                    <el-table-column width="100" label="活动开始时间" prop="start_time"></el-table-column>
                                </el-table>
                                <span slot="reference" class="operate">{{row.stock_quantity}}</span>
                            </el-popover>
                        </td>
                        <!-- 调拨在途 -->
                        <td>
                        ...
                        <td>
                            <el-popover placement="bottom"
                                        ...
                                        trigger="click"
                                        width="400">
                                <el-table :data="ageData"
                                          max-height="300"
                                          class="scroll-bar">
                                    <el-table-column width="130" label="入库单号" prop="code"></el-table-column>
                                    <el-table-column width="100" label="入库时间" prop="in_time"></el-table-column>
                                    <el-table-column width="70" label="剩余数量" prop="qty"></el-table-column>
                                    <el-table-column width="100" label="库龄" prop="age"></el-table-column>
                                </el-table>
                                <span slot="reference" class="operate">{{row.age}}</span>
                            </el-popover>
                        </td>
                        <!--销售时间-->
...
<script>
    import {api_local_detail, api_shipping_detail, api_stocking_detail, api_stocking_lock_detail, api_get_age_detali} from '@/api/local';
    ...
    export default {
        ...
        methods: {
            ...
            look_age(data) {
                ...
                this.ageData = [];
                this.$http(api_get_age_detali, params).then(res => {
                    this.ageData = res;
                }).catch(err => {
...
//            操作的值
            ...
            show_stock(id) {
                ...
                this.stockDetail = [];
                this.$http(api_stocking_detail, data).then(res => {
            ...
            show_lock_stock(id) {
                ...
                this.stockLockDetail = [];
                this.$http(api_stocking_lock_detail, data).then(res => {
                    this.stockLockDetail = res;
                }).catch(code => {
                    this.$message({type: 'error', message: code.message || code});
                })
            }
        ...
        computed: {
            ...
            isFBA() {
                return [187,489].includes(this.warehouse_id);
            }
        },
        props: {
            tables: {
