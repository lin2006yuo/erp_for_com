<template>
    <div class="warehouse-data">
        <el-table
            ...
            <el-table-column label="平台订单号" prop="order_number"></el-table-column>
            ...
            <el-table-column label="退款日期" prop="refund_date"></el-table-column>
            <el-table-column label="退款金额原币" prop="refund"></el-table-column>
            <el-table-column label="币种" prop="currency_code"></el-table-column>
            <el-table-column label="汇率" prop="rate"></el-table-column>
            <el-table-column label="退款金额￥" prop="refund_cny"></el-table-column>
        </el-table>
        <el-pagination
            class="page-fixed"
