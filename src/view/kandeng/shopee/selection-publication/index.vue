    ...
    <page class="p-index">
        ...
        <search-card @search="search" @enter="search" :params="searchData" :clears="clears" style="overflow:initial;" :is-search="isSearch">
            <label-item label="账号简称：" class="mr-sm">
                <super-select class="mr-sm s-width-default"
	...
	export default{
        ...
        methods:{
            ...
            init(){
                ...
                data.category_id=this.searchData.category_id.length<=1?this.searchData.category_id.join(''):this.searchData.category_id[this.searchData.category_id.length-1]
