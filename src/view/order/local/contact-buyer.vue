    ...
    export default {
        ...
        methods: {
            ...
            post_message() {
                ...
                if (this.excute==='batch_contact') {
                    this.$http(api_orders_batch_send_messag, {order_ids: this.mdfid, text: this.msgText}).then(res => {
                        this.$message({
                            type: 'success',
                    ...
                    switch (this.channel_id) {
                        case 4:
                            this.$http(api_reply, {order_id: this.mdfid, text: this.msgText}).then(res => {
                                this.$message({
                                    type: 'success',
                                    message: res.message || res
                                });
            ...
            select_msg_text() {
                ...
                this.$http(api_msg_tpl_content, {
                    ...
                    search_id: this.mdfid instanceof Array?this.mdfid[0]:this.mdfid,
                    search_type: 'order',
                    channel_id: this.channel_id
                }).then(res => {
