        ...
        <page-dialog title="选择账号"
            ...
            <div slot="footer">
                <el-button size="mini" type="primary"
                           @click.native="add_data">{{$t('common.confirm')}}</el-button>
                <el-button size="mini" @click.native="dialog = false">{{$t('common.close')}}</el-button>
            </div>
...
<script>
    ...
    export default{
        ...
        methods:{
            size_change(size){
                this.pageSize = size;
                this.filterData=this.filter.slice((this.page-1)*this.pageSize,this.pageSize*this.page);
            },
            current_change(page){
                this.page = page;
                this.filterData=this.filter.slice((this.page-1)*this.pageSize,this.pageSize*this.page);
            ...
            openDialog(){
                this.filter=this.accountList;
                this.filterData=this.accountList.slice(0,this.pageSize);
            ...
            search(){
                ...
                this.filter=this.accountList.filter(row=>{
