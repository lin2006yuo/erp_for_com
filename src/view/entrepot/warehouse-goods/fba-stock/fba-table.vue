<template>
    <div>
        ...
        <detail-dialog v-model="detailShow" :row="rowDetail" :isFba="isFba"></detail-dialog>
        ...
        <stock-cycle v-model="cycleVisible" :form-data="cycleForm" @set-stock-cycle="set_stock_cycle"></stock-cycle>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            apply_stock() {
                ...
                this.channelData = this.skuIdData.map(data => {
                    return {
                        ...
                        ready_advice_qty: data.ready_advice_qty
                    }
                });
                this.dialogShow = true;
                this.valueShow = 2;
            ...
            //获取备货周期
            get_stock_cycle() {
                this.$http(api_get_stock_cycle, { warehouse_id: this.warehouse_id }).then(res => {
                    this.cycleForm = res;
            ...
            set_stock_cycle() {
                let params = {
                    ...
                    purchase_delivery: this.cycleForm.purchase_delivery.trim(),
                    internal_friction_days: this.cycleForm.internal_friction_days.trim(),
                    intransit_days: this.cycleForm.intransit_days.trim(),
                    safe_inventory_days: this.cycleForm.safe_inventory_days.trim()
                };
                this.$http(api_set_stock_cycle, params).then(res => {
        ...
        components: {
            ...
            stockCycle: require('./stock-cycle.vue').default
        }
    }
</script>
