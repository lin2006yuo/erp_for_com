...
//获取spu侵权列表
export const url_get_spu_tort_list = 'get|goods/goods-tort-description-list';
export const api_get_spu_tort_list = function (data){
    return http(url_get_spu_tort_list,data);
};

//侵权记录导入
export const url_tort_import='post|goods/tort-import';
export const api_url_tort_import=(data)=>{
    return http(url_tort_import,data,{
...
//侵权记录导出
export const url_tort_export='post|goods/tort-export';
export const api_url_tort_export=(data)=>{
    return http(url_tort_export,data);
}

//侵权添加
export const url_tort_add='post|goods/goods-tort-description$';
export const api_tort_add=(data)=>{
    return http(url_tort_add,data)
}

//侵权编辑
export const url_tort_edit='put|goods/goods-tort-description/:id';
export const api_tort_edit=(id,data)=>{
    return http(Url2(url_tort_edit,{id:id}),data);
}

//侵权邮件图片上传
export const url_add_tort_emailphote='post|goods/goods-tort-description/email-photo$';
export const api_add_tort_emailphote=(data)=>{
    return http(url_add_tort_emailphote,data);
}
