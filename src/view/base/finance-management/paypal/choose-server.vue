            ...
            <el-table
                ...
                <el-table-column width="50">
                    <template slot-scope="scope">
                        <el-radio v-model="serverRadio" :label="scope.row.id"
                                  @change.native="getServerRow(scope.row)">&nbsp</el-radio>
                    </template>
                </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            confirm(){
                if(!this.serverObj){
                    return this.$message({type:'warning',message: "请选择一项服务器IP地址"});
                }else {
                    this.visible = false;
