    ...
    export default{
        ...
        data(){
            return{
                ...
                pickerStart: {
                    disabledDate: (time) => {
                        if (this.totalData.end_time) {
                            return time.getTime() > this.totalData.end_time;
                        } else {
                ...
                pickerEnd: {
                    disabledDate: (time) => {
                        if (this.totalData.start_time) {
                            return time.getTime() < this.totalData.start_time||time.getTime()>Date.now();
                        }
                    }
                },
            }
