...
<!--                                   :remote="channel_remote"></select-remote>-->
                <super-select   v-model="baseData.channel_id"
                                class="width-sm"
                                :options="channelOptions"
                                storageKey="baseInfoChannelSelect-2">
                </super-select>
            </el-form-item>
...
<!--                    </el-option>-->
<!--                </el-select>-->
                <super-select   v-model="baseData.account_id"
                                :disabled="baseData.channel_id<=0"
                                class="width-sm"
                                :placeholder="accoutPlaceholder"
                                :options="accoutOptions"
                                storageKey="baseInfoAccountSelect">
                </super-select>
            </el-form-item>
