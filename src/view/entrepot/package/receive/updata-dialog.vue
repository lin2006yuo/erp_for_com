        ...
        <page-dialog title="" v-model="visible" size="small" :close-on-click-modal="false">
            ...
            <el-form ref="form" :model="updateForm" label-width="100px">
                ...
                <el-form-item label="包裹数量：">
                    <el-input-number v-model.number="updateForm.parcel_num"
                                     class="width-lg"
                ...
                <el-form-item label="包裹状态：">
                    <span :class="{redColor:updateForm.is_use}">{{updateForm.is_use_text}}</span>
                </el-form-item>
                <el-form-item label="异常类型：">
                    <span>{{updateForm.receive_abnormal_text}}</span>
                </el-form-item>
                <el-form-item label="是否同步给采购：">
                    <span>{{updateForm.sync_purchase ? '是' : '否'}}</span>
                </el-form-item>
                <!--<el-form-item label="采购员：">
                    <span>{{updateForm.is_use_text}}</span>
                </el-form-item>-->
                <el-form-item label="备注：">
                    <span>{{updateForm.remark}}</span>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer t-center mt-md">
                <el-button @click.native="submit_btn" class="mr-md" size="mini" type="primary">确定</el-button>
    ...
    export default {
        ...
        methods: {
            submit_btn() {
                ...
                if(this.updateForm.parcel_num === '') {
                    return this.$message({type: 'warning', message: '请填写包裹数！'});
                }
                // 包裹数为整数
                this.updateForm.parcel_num = parseInt(this.updateForm.parcel_num);
                let params = {
                    ...
                    field_info: [
                        ...
                        {parcel_num: this.updateForm.parcel_num},
                    ]
                };
