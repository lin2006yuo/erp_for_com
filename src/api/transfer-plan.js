...
//亚马逊货件编码校验
// export const url_amazon_shipment_check = "get|allocation/check-shipment"
// export const api_amazon_shipment_check = function (data) {
//     return http(url_amazon_shipment_check,data);
// };

//重新预报亚马逊
// export const url_amazon_reforecast = "put|allocation/reforecast/:id"
// export const api_amazon_reforecast = function (id) {
//     return http(Url2(url_amazon_reforecast, {id: id}));
// };

//调拨退回
export const url_put_allocation_return = "put|allocation/return/:id"
export const api_put_allocation_return = function (id, data) {
    return http(Url2(url_put_allocation_return, {id: id}), data);
};