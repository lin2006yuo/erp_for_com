<template>
    <page class="channel-profit">
        <search-module @init-data="init_data" ref="search_module" :channel-id="20"></search-module>
...
<script>
    import {api_report_yandex} from  '@/api/report-channel'
    ...
    export default{
        ...
        data(){
            return{
                apiTableData: api_report_yandex
            }
        }
    }
</script>
