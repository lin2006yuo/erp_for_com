        ...
        <rainbow-header title="图片与描述" background-color="#ABCD05">
            <el-form :model="form" label-width="220px">
                ...
                <el-form-item label="销售说明模板：">
                    <el-row>
                        <el-col :span="commonSpan">
                            <super-select v-model="form.list.mod_sale"
                                          ref="modsale"
                                          v-mouse-side.mousewheel="()=>{$refs.modsale.visible=false}"
                                          :options="saleList"
                                          storage-key="ebaySaleList">
                            </super-select>
                        </el-col>
                    </el-row>
                </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            /*获取刊登风格*/
            get_stylelist() {
                this.$http(api_get_stylelist,{type:'style'}).then(res => {
