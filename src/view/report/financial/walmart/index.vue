<template>
    <page class="channel-profit">
        <search-module @init-data="init_data" ref="search_module" :channel-id="11"></search-module>
...
<script>
    import {api_report_walmart} from  '../../../../api/report-channel'
    ...
    export default{
        ...
        data(){
            return{
                apiTableData: api_report_walmart
            }
        }
    }
</script>
