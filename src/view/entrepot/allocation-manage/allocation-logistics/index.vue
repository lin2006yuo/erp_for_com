...
<script>
    ...
    import {api_allocation_logistics} from "@/api/allocation-logistics";
    import {
        api_warehouse_get,
        api_get_status,
    ...
    export default {
        ...
        methods: {
            ...
            init_statusList() {
                this.$http(api_get_status, {list_type: 2}).then(res => {
            ...
            init() {
                ...
                this.loading = true;
                this.$http(api_allocation_logistics, data).then(res => {
                    //初始化列表数据
