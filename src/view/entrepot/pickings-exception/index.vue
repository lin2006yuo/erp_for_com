    ...
    <page class="pabe-pickings-exception">
        <div>
            <label-item label="请选择仓库：" class="mb-xs mt-xs">
                <super-select v-model="warehouse_id" @change="changeWarehouse"
                              class="inline width-sm"
                              :options="warehouses"
                              storage-key="pickingExceptionWarehouse"></super-select>
        ...
        <search-card :params="searchData" @search="init" :clears="clears" class="mb-xs">
            ...
            <label-item label="拣货人：" class="inline ml-sm mb-xs">
                <super-select class="width-md" v-model="searchData.shipper_id" v-sf.shipper_id
                              :options="shipperList"
                              storage-key="staffs"></super-select>
                <!--<param-account
                        class="width-md"
                        v-sf.shipper_id
        ...
        <div>
            <permission tag="requestButton"
                        ...
                        @click.native="checkerDialog = true">
                生成盘点单
            </permission>
        </div>
        <ui-table
            ...
            <template v-for="(data, index) in tableData">
                <tr :class="[data.show ? 'active' : '',data.heighLight?'active-color':'']" @click="addClass(index)"
                    ...
                    <!-- 盘点单号 -->
                    <td>
                        <ui-tips v-if="data.warehouse_goods_check_id>0" :content="data.warehouse_goods_check_id"
                                 :width="65"></ui-tips>
                        <div v-else>--</div>
                    </td>
                    <!-- 盘点完成时间 -->
        ...
        <point-checker v-model="checkerDialog" @submit="mark_processed"></point-checker>
        <el-pagination
                class="page-fixed"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            mark_processed(id, realName) {//生成盘点单
        ...
        components: {
            ...
            pointChecker: require('./point-checker').default
        }
    }
</script>
