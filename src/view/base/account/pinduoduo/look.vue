<template>
    <page-dialog v-model="dialog" size="small" :close-on-click-modal="false" :title="title" @close="close">
        <el-form :model="form" label-width="200px" :rules="rules" ref="form" style="margin: 0 auto">
            <el-form-item label="简称：" prop="code">
                <el-col :span="14">
                    <el-input v-if="curPage === 'add'" v-model="form.code" disabled></el-input>
                    <span v-else>{{form.code}}</span>
                </el-col>
            </el-form-item>
            <el-form-item label="账号名称：" prop="account_name">
                <el-col :span="14">
                    <el-input v-if="curPage === 'add'" disabled v-model="form.name"></el-input>
        ...
        <div slot="footer">
            <el-button  v-if="curPage === 'add'" type="primary" size="mini" class="inline" @click.native="submit">确 定</el-button>
            <el-button v-if="curPage === 'add'" size="mini" class="inline" @click.native="dialog = false">取 消</el-button>
            <el-button v-else size="mini" class="inline" @click.native="dialog = false">关 闭</el-button>
        </div>
    </page-dialog>
</template>
<style lang="stylus">
