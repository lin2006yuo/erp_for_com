<template>
    <page class="p-index">
        ...
        <!-- 授权 -->
        <authorize v-model="authorizeVisable"
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            setClich(val){
                let searchData = val;
                this.$set(searchData,'ids',this.selectData.join(','));
                this.$http(api_shopee_post_batch_set,searchData).then(res=>{
                    this.init();
            ...
            init(){
                ...
                searchData.start_time=this.searchData.start_time?datef('YYYY-MM-dd', this.searchData.start_time/1000):'';
                searchData.end_time=this.searchData.end_time?datef('YYYY-MM-dd', this.searchData.end_time/1000):'';
                if(searchData.site === ''){
                    delete searchData.site;
                };
                this.$http(api_shopee_account,searchData).then(res=>{
                    this.shopeeList.list = res.data;
