    ...
    <div class="p-accounts">
        <page-dialog :title="$t('ymx-detail.selectAcc')" v-model="accountVisiable"
            ...
            <el-row class="mb-sm ">
                ...
                <el-input v-model="snText" class="inline" @keyup.enter.native="search" :placeholder="$t('ymx-detail.pleaseInput')"></el-input>
    ...
    export default{
        ...
        methods: {
            ...
            search(){
                ...
                this.searchData=this.accounts.filter(row=>{
            ...
            row_click(row,event,col){
                if(row.disabled||this.curChannel==='Amazon')return;
            ...
            handle_size_change(val){
                this.pageSize = val;
                this.accountsFilter=this.searchData.slice((this.page-1)*this.pageSize,this.pageSize*this.page);
            },
        ...
        watch: {
            ...
            accounts(val){
                ...
                this.searchData=val;
                /*默认只显示前15条数据*/
                this.accountsFilter=this.searchData.slice(0,15);
                this.total=this.searchData.length;
            },
            searchData(val){
                this.accountsFilter=val.slice((this.page-1)*this.pageSize,this.pageSize*this.page);
            }
        },
        props: {
            curChannel:{
