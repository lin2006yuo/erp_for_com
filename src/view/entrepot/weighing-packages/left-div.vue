<template>
    <div class="p-weighing-packages">
        ...
        <table-module :search-data="searchData"
                      ...
                      @show-printdata="show_print_data"
                      class="mt-xs"
                      ref="table_module">
        </table-module>
    ...
    export default {
        ...
        methods: {
            ...
            cleanSearchData() {
                ...
                this.$refs.search_module.size.length = 0;
                this.$refs.search_module.size.width = 0;
                this.$refs.search_module.size.height = 0;
