    ...
    <page class="p-picking-sku">
        ...
        <search-card :params="searchData" @search="search" :clears="clears" class="mt-xs">
            ...
            <label-item label="接收员：" class="inline ml-sm">
                <super-select v-sf.creator_id
                              v-model="searchData.creator_id"
                              :options="receiving_clerk"
                              filterable
                              class="s-width-default"
                              storage-key="receiver"></super-select>
            ...
            <label-item label="拆包员：" class="inline ml-sm">
                <super-select v-model="searchData.unpacking_id" class="s-width-small"
                              :options="unpackNameList"
                              filterable clearable
                              storage-key="unpack"></super-select>
        ...
        methods: {
            ...
            init_unpack_list() {
                this.$http(api_box_unpack_name_list).then(res => {
                    ...
                    this.unpackNameList = res.list.map(row => {
                        return {
                            label: row.unpacked_name,
                            value: row.key,
                        }
                    });
                })
