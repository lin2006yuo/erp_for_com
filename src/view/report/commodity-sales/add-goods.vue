        ...
        <el-row :gutter="8" class="mt-xs">
            ...
            <el-col :span="21">
                <el-table
                    ...
                    @row-click="row_click"
                >
                    <el-table-column :reserve-selection="true" type="selection" width="35" row-key="id"></el-table-column>
            ...
            get_goods() {
                ...
                if (this.snType && this.snText) {
                    ...
                    if(this.snType==='sku'||this.snType==='spu'){
                        ...
                        if(this.limit && params.snText.split(',').length > this.limit) {
                            this.isLoading = false;
                            return this.$message({ type: 'warning', message: `批量搜索只支持${this.limit}条数据！` })
                        }
                    }else{
...
//                保存
            ...
            //重新打开后数据回显
            rewrite() {
                if(this.addForm &&  this.addForm.length) {
