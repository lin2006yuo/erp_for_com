...
<!--                                ></el-option>-->
<!--                            </ui-select>-->
                            <super-select   v-model="devData.company_id"
                                            :options="companys"
                                            storageKey="product-class-setting-companys"
                                            placeholder="请选择公司...">
                            </super-select>
                        </el-form-item>
                    </el-col>
...
<!--                                ></el-option>-->
<!--                            </ui-select>-->
                            <super-select   v-model="devData.developer_id"
                                            :options="devOptions"
                                            storageKey="product-class-setting-developer"
                                            placeholder="请选择公司...">
                            </super-select>
                        </el-form-item>
                    </el-col>
...
<!--                                </el-option>-->
<!--                            </ui-select>-->
                            <super-select   v-model="devData.category_id"
                                            :options="category"
                                            style="width:200px"
                                            placeholder="请选择类别..."
                                            :disabled="isEditStatus"
                                            storageKey="product-class-setting-categories2"
                                            @change="change_category">
                            </super-select>
