<template>
    <page class="channel-profit">
        <search-module @init-data="init_data" ref="search_module" :channel-id="9"></search-module>
...
<script>
    import {api_report_shopee} from  '../../../../api/report-channel'
    ...
    export default{
        ...
        data(){
            return{
                apiTableData: api_report_shopee
            }
        }
    }
</script>
