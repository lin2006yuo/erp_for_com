<template>
    <div class="p-paypal-table">
        <el-table  v-resize="{height:38}"
            ...
            <el-table-column inline-template label="关联交易号" align="center" v-if="clientWidth" :resizable="false">
                <div>
                    <ui-tip :content="row.reference_id" :width="98"></ui-tip>
                </div>
            </el-table-column>
