...
//平台类型
export  const url_channel_type = "get|channel-node/channel-type";
export  const api_channel_type = function (data) {
    return http(url_channel_type,data)
};

//设置平台为主网址
export const url_node_first_site = "post|channel-node/first-site";
export const api_node_first_site = function(data){
    return http(url_node_first_site,data);
}
//获取邮局平台
export const url_available_list = "get|postoffice/available-list";
export const api_available_list = function () {
    return http(url_available_list);
};