<template>
    <div class="my-mall-overseas-data-list relative">
        <el-table
            class="scroll-bar"
            ref="multipleTable"
...
<!--                class="buyer-wrap"-->
                <div>
                    ...
                    <span class="buyer-id" v-html="row.buyer"></span>
            ...
            <el-table-column label="支付总额" min-width="50" inline-template>
                <div class="p-table-list-td-text" :title="row.pay_fee | filterPrice">{{row.currency_code}} {{row.pay_fee | filterPrice}}</div>
            </el-table-column>
            ...
            <el-table-column min-width="40" label="支付时间" inline-template>
             ...
             <el-table-column min-width="40" label="订单状态" inline-template>
                <div>
                    <ui-tip :content="row.order_status" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column  min-width="60" label="运输方式" inline-template>
                <div>
...
<script>
    ...
    import {api_my_mall_look, url_my_mall_look} from'@/api/my-mall-info';
    ...
    export default{
        ...
        methods:{
            ...
            lookOver(row){
                ...
                let ids = row.id;
                this.$http(api_my_mall_look, {id: ids}).then(res => {
