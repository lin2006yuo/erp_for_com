...
// 获取操作人的数量。
export const url_get_option = "get|user";
export const api_get_option = function (data) {
    return http(url_get_option,data);
};
//获取资源
export const url_get_resource = "post|publish-rules/resources";
