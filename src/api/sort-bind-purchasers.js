...
export const url_sku_manager_getUser = "get|user/skuManager/staffs";
export const getSkuManager = function() {
    return http(Url2(url_sku_manager_getUser));
};
...
//修改sku查重文员
export const url_edit_skuManger = 'put|categories/:id/sku-shecking-save'
export const api_edit_skuManger = function (id,data){
    return http(Url2(url_edit_skuManger,{id}),data)
}
