...
//绑定账号数列表
export const url_card_info = "get|credit-card/:id/account-info";
export const api_card_info = function (id) {
    return http(Url2(url_card_info,{id:id}));
};

//导入文件
export const url_post_credit_card_batch_import = "post|credit-card/batch-import";
export const api_post_credit_card_batch_import = function(data){
    return http(url_post_credit_card_batch_import,data)
};

//下载导出模板
export const url_get_import_template = "get|credit-card/import-template";
