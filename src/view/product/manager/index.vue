    ...
    <page class="p-index">
        ...
        <goods-classify ref="classifyPart">
            ...
            <tabledata-list class="card"
                            ...
                            @change-operation="change_operation"
                            v-resize="{height:75}"
        ...
        <look-edit v-model="lookVisable"
                   :edit-able="editAble"
                   :goodsId="lookEdit.goodsId"
                   :pageSize="tableObj.pageSize"
                   :currentPage="tableObj.page"
                   :spu="lookEdit.spu" ref="looks"
                   :child-active-name="lookEdit.activeName"
...
<script>
    ...
    import {
        publish_product, api_export, api_export_sku, api_goods_set_purchaser, api_download_shopee,
        api_goods_export_field, api_goods_export_template, api_download_discount, api_download_walmart,
        api_download_lazada, api_export_noon, api_distribution_push
    ...
    export default {
        ...
        methods: {
            change_operation(obj){
                this.lookEdit ={
                    activeName:obj.activeName,
                    spu:obj.spu,
                    goodsId:obj.goodsId
                };
                obj.option.action.apply(this,[obj.data,obj.option])
            },
            get_fields() {
