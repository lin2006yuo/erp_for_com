        ...
        <el-table
            ...
            <div slot="empty" class="no-data-reminder">
                ...
                <el-table-column label="退回单号" inline-template>
                    <div>
                        <ui-tip :content="row.return_number" :width="98"></ui-tip>
                    </div>
                </el-table-column>
...
<script>
    import {api_overseas_package_return_id} from '@/api/overseas-package-return'
...
export default {
    ...
    methods: {
        ...
        look_package(row) {
            ...
            this.$http(api_overseas_package_return_id, row.id).then(res => {
