    ...
    export default {
        ...
        methods: {
            ...
            get_params() {
                ...
                //处理category_id
                if(params.category_id && params.category_id.length === 1) params.category_id = params.category_id[0]
                else if(params.category_id && params.category_id.length === 2) params.category_id = params.category_id[1]
