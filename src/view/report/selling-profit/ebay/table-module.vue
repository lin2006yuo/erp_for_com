...
<template>
    <div>
        <el-table :data="tableData"
            ...
            <el-table-column key="sale_group_leader" label="销售组长" inline-template v-if="is_salesman">
                <div>
                    <ui-tip :content="row.sale_group_leader" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column key="sale_director" label="销售主管" inline-template v-if="is_salesman">
                <div>
                    <ui-tip :content="row.sale_director" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column key="order_num" label="订单数" inline-template :width="70">
                <div>
            ...
            <el-table-column key="channel_cost" label="平台费用CNY" width="120px" inline-template>
                <div>
                    <ui-tip :content="row.channel_cost | toFixed2" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column  label="PayPal费用" inline-template>
                <div>
            ...
            <el-table-column label="转运费" inline-template v-if="is_overwarehouse">
                <div>
                    <ui-tip :content="row.trans_shipping_fee | toFixed2" :width="98"></ui-tip>
                </div>
            </el-table-column>
