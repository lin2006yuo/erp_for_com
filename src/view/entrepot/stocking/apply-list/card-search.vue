    ...
    <div class="c-card-search">
        <search-card @search="search" @init-params="init_btn" :params="paramsData" :clears="clears">
            ...
            <label-item label="平台：" class="inline ml-sm">
                <super-select v-model="paramsData.channel_id"
            ...
            <label-item label="备货仓库：" class="inline ml-sm">
                <super-select v-model="paramsData.warehouse_id"
                              class="inline width-xs"
                              :options="warehouses"
                              storageKey="applyStockWarehouse"></super-select>
                <!--<el-select class="inline width-xs"-->
                           <!--filterable-->
            ...
            <label-item label="中转仓库：" class="inline ml-sm">
                <super-select v-model="paramsData.transit_warehouse_id"
                              class="inline width-xs"
                              :options="transitWarehouse"
                              storageKey="applyTransitWarehouse"></super-select>
