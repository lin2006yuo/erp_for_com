...
//warehouseStaffs列表
export const url_get_staffs_list = "get|user/warehouse/staffs";
export const api_get_staffs_list = function() {
    return http(url_get_staffs_list, {content: ''});
};

//warehouseDeveloper列表
export const url_get_developer_list = "get|user/development/staffs";
export const api_get_developer_list = function() {
    return http(url_get_developer_list);
};