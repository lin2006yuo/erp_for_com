    ...
    export default {
        ...
        methods: {
            ...
            get_params() {
                ...
                }else if(searchData.date_b){
                    searchData.date_b = new Date(datef('YYYY-MM-dd', searchData.date_b/1000))/1000-8*60*60;
                }else{
                    searchData.date_b = ''
                }
                if (searchData.date_e instanceof Date) {
                    searchData.date_e = searchData.date_e.getEndDaySTime();
                }else if(searchData.date_e){
                    searchData.date_e = new Date(datef('YYYY-MM-dd', searchData.date_e/1000))/1000+16*60*60;
                }else{
                    searchData.date_e = ''
                }
