    ...
    <div class="p-set-sore-classify-search">
        <search-card @search="search" @enter="search" :params="searchData" :clears="clears">
            ...
            <super-select
                ...
                v-sf.joom_account_id
                v-model="searchData.joom_account_id"
                @change="select_account"
                :options="joom_account"
            ...
            <super-select
                class="inline s-width-middle"
                v-sf.shop_id
                v-model="searchData.joom_shop_id"
                :options="joom_store"
                storageKey="joomShop"
                :isPaging="false"
...
<script>
    ...
    export default{
        ...
        methods: {
            ...
            get_joom_store(){
                this.$http(api_get_joom_store, {channel_id:7,account_id: this.searchData.joom_account_id}).then(res => {
                    this.joom_store = [...res.data];
                })
            }
        },
        computed: {
