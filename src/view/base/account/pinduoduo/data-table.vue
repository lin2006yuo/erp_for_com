<template>
    <div class="c-table-data">
        <el-table
            ...
            <el-table-column width="140" label="拼多多状态" inline-template>
            ...
            <el-table-column width="90" inline-template label="账号状态">
                <ui-tip :content="row.site_status_str" :width="98" v-copy></ui-tip>
            </el-table-column>
            <!--<el-table-column width="290" label="操作" inline-template>-->
                <!--<div>-->
                    ...
                    <!--&nbsp;|&nbsp;-->
                    <!--<span class="operate" @click="look_log(row)">日志</span>-->
                <!--</div>-->
            <!--</el-table-column>-->
...
<script>
    import {url_refresh_token,api_refresh_token,api_account_log,
        url_look_account,url_edit_account,
        url_pdd_authorcode,url_account_log} from '@/api/pdd';
    ...
    export default {
        ...
        methods:{
            selects(row){
                ...
                let buttons = [
                    {label:'查看',value:0, apis:'url_look_account'},
                    {label:'编辑',value:1, apis:'url_edit_account'},
                    {label:is_authorization,value:2, apis:'url_pdd_authorcode'},
                    // {label:'账号负责人',value:3, apis:'url_add_member'},
                    {label:'更新token',value:4, apis:'url_refresh_token'},
            ...
            trigger(row,val){
                switch (val.value){
                    case 0:
                        this.examine_look(row);
                        break;
                    case 1:
                        this.edit_compile(row);
                        break;
                    case 2:
                        this.edit_authorization(row);
                        break;
                    case 3:
                        this.add_member(row);
                        break;
...
//            添加成员事件
            add_member(row){
                ...
                this.api_add_member({channel_id:19,account_id:row.id});
            },
//            添加成员
            api_add_member(val){
