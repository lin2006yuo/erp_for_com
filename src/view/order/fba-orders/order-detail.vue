        ...
        <page-dialog title="" size="large" v-model="visible" :close-on-click-modal="false">
            ...
            <el-table
                ...
                <el-table-column
                        ...
                        inline-template>
                    <div>
                        <ui-tip :content="`${row.channel_sku}/${row.sku}`" :width="98"></ui-tip>
                    </div>
                </el-table-column>
                <el-table-column
                        inline-template
                        label="产品金额">
                    <div>
                        <ui-tip :content="`${row.currency_code}${Number(row.channel_sku_price).toFixed(2)}`" :width="98"></ui-tip>
                    </div>
                </el-table-column>
                <el-table-column
                        show-overflow-tooltip
