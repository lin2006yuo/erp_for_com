...
//获取商品描述
export const url_get_goods_desc='get|publish-ebay/goods/desc';
export const api_get_goods_desc = function (data) {
    return http(url_get_goods_desc,data);
}
//  保存商品描述
export const url_save_goods_desc='post|publish-ebay/goods/desc';
export const api_save_goods_desc = function (data) {
    return http(url_save_goods_desc,data);
}
