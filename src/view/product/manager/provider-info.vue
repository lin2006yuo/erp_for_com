            ...
            <el-form label-width="130px">
                <el-form-item label="采购员：" >
                    <!--<el-select class="inline" ref="purchaserId"-->
                        ...
                        <!--</el-option>-->
                    <!--</el-select>-->
                    <super-select v-model="providerData.purchaser_id"  class="inline"
                                  v-if="editAble" @change="change_purchaser"
                                  :options="purchasers" storageKey="purchaserList"></super-select>
                ...
                <el-form-item  v-for="(item,index)  in providerData.supplier"
                    ...
                    <el-row class="mb-sm">
                        ...
                        <el-col :span="6">
                            <span>供应链专员：</span>
                            <span>{{item.supply_chain_specialist_name}}</span>
                        </el-col>
                    </el-row>
                    <el-table
                        :data="item.skus"
        ...
        methods:{
            change_purchaser(){
              let find=this.purchasers.find(row=>{
                 return  row.value===this.providerData.purchaser_id
              })
                if(!!find){
                    this.providerData.purchaser=find.label
                }
            },
            keep_(){
                this.$emit("keep")
