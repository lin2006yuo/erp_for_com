...
export const api_get_number = function(data){
  return http(url_get_number,data)
};
//获取国家
...
// 保存线下订单
export const url_add_orders_offline = "post|manual-orders/offline"
export const api_add_orders_offline = function(data){
    return http(url_add_orders_offline,data)
};
// 保存补发订单
export const url_add_orders_reissue = "post|manual-orders/reissue"
export const api_add_orders_reissue = function(data){
    return http(url_add_orders_reissue,data)
};
// 保存补差价订单
export const url_add_orders_price = "post|manual-orders/price"
export const api_add_orders_price = function(data){
    return http(url_add_orders_price,data)
};
...
//导入手工线下订单
export const url_post_import_offline = "post|manual-orders/import/offline"
export const api_post_import_offline = function(data){
    return http(url_post_import_offline,data)
};
//导入手工补发订单
export const url_post_import_reissue = "post|manual-orders/import/reissue"
export const api_post_import_reissue = function(data){
    return http(url_post_import_reissue,data)
};
//导入手工补差价订单
export const url_post_import_price = "post|manual-orders/import/price"
export const api_post_import_price = function(data){
    return http(url_post_import_price,data)
};
//保存手工订单
...
//保存手工线下订单
export const url_save_import_offline = "post|manual-orders/save-import/offline"
export const api_save_import_offline = function(data){
    return http(url_save_import_offline,data)
};
//保存手工补发订单
export const url_save_import_reissue = "post|manual-orders/save-import/reissue"
export const api_save_import_reissue = function(data){
    return http(url_save_import_reissue,data)
};
//保存手工差价订单
export const url_save_import_price = "post|manual-orders/save-import/price"
export const api_save_import_price = function(data){
    return http(url_save_import_price,data)
};
//获取订单拦截状态
...
//获取店铺
export const url_get_order_joom_shop = "get|joom-orders/joom-shop"
export const api_get_order_joom_shops = function(data){
    return http(url_get_order_joom_shop,data)
};
//手工订单导出
