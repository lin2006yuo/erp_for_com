...
//复制箱子
export const url_allocation_copy_box = "put|packing-manage/copy-box";
export const api_allocation_copy_box = function (data) {
    return http(url_allocation_copy_box, data);
};
