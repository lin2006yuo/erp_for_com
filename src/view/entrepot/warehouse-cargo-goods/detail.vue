        ...
        <div class="card">
            <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                <el-tab-pane label="库存操作明细" name="first" class="table-card">
                    <search-card @search="request_detail" :params="paramsData" :clears="clears">
                ...
                <el-tab-pane label="货位绑定记录" name="second">
                    <el-table v-if="activeName === 'second'"
                ...
                <el-tab-pane label="货位记录" name="third">
                    <el-table v-if="activeName === 'third'"
                              highlight-current-row
                              :data="logDataLists"
                              class="scroll-bar"
                              v-resize="{height: 150}"
    ...
    export default {
        ...
        methods: {
            ...
            request_detail() {
                ...
                Object.assign(params, this.paramsData);
