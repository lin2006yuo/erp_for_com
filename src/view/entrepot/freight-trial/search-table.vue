                    ...
                    <el-tab-pane label="按重量试算" name="first">
                        <table class="big-table">
                            <tr>
                                ...
                                <td>
                                    <super-select class="s-width-large width-xs" v-model="form.warehouse_id"
                                                  :options="warehouseList"
                                                  storage-key="freightTrailWarehouse"></super-select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <super-select v-model="form.country_code"
                                                  class="s-width-large"
                                                  storageKey="trialCountryList"
                                                  :options="countryList"></super-select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="mb-mini">
                                        <span>长：</span>
                                        <ui-limit-number class="inline" v-model="form.length"
                                                         :limit="1"></ui-limit-number>
                                        <span>cm</span>
                                    </div>
                                    <div class="mb-mini">
                                        <span>宽：</span>
                                        <ui-limit-number class="inline" v-model="form.width"
                                                         :limit="1"></ui-limit-number>
                                        <span>cm</span>
                                    </div>
                                    <div class="mb-mini">
                                        <span>高：</span>
                                        <ui-limit-number class="inline" v-model="form.height"
                                                         :limit="1"></ui-limit-number>
                                        <span>cm</span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="inline mr-xs s-width-large el-input__inner" v-model="form.weight"
                                           type="number" min="0" onkeyup="this.value=this.value.replace(/\.{2,}/g, '')"
                                           onafterpaste="this.value=this.value.replace(/\.{2,}/g, '')"><span>g</span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td></td>
                                <td>
                                    <el-button type="primary" @click.native="search" size="mini"
                                               v-permission.inquire="'entrepotFreight'">提交查询
                                    </el-button>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="big-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <super-select class="s-width-large width-xs" v-model="form.warehouse_id"
                                                  :options="warehouseList"
                                                  storage-key="freightTrailWarehouse"
                                    ></super-select>
                                ...
                                <td>
                                    <el-form :model="form" ref="form">
                                        <div v-for="(item,index) in form.sku" :key="index">
                                            ...
                                            <div class="mt-mini inline sku-operate" @click="delete_sku(index)"
                                                 v-if="index>0">
...
<script>
    import {
        ...
        api_get_postway,
        api_trial_index,
        api_shipping_method_property
    } from '@/api/freight-trial';
