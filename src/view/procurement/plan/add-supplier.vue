            ...
            <div style="height: 300px;overflow-y: auto;">
                <table class="template">
                    ...
                    <tr v-for="(data, index) in supplierData" @click="select_radio(data)">
                        ...
                        <td>{{data.label_deck|filterLabelDeck}}</td>
                        <td>{{data.return_goods|filterReturnGoods}}</td>
                        <td>
                            <span v-if="data.return_goods===1">{{ data.return_goods_data|filterReturnGoodsData }}</span>
                            <span v-else>--</span>
                        </td>
                        <td><span>{{data.balance_type_text}}</span></td>
                        <td><span>{{data.audited_price}}</span></td>
