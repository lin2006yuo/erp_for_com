<template>
    <page class="channel-profit">
        <search-module @init-data="init_data" ref="search_module" :channel-id="10"></search-module>
...
<script>
    import {api_report_paytm} from  '@/api/report-channel'
