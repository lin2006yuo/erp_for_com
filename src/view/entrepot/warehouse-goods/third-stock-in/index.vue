    ...
    <page class="p-third-stock-in">
        <search-card :params="searchData" :clears="clear" @search="search">
            <el-row class="mb-xs">
                ...
                <label-item label="用途类型：" class="inline ml-sm">
                    <el-select v-model="searchData.type"
                               filterable clearable v-sf.type class="width-sm">
            ...
            <label-item label="创建人：" class="inline ml-sm">
                <super-select v-model="searchData.creator_id"
                              ...
                              class="s-width-default"
                              :options="creatorList"
                              storageKey="warehouseCreator"></super-select>
            ...
            <label-item label="审批人：" class="inline ml-sm">
                <super-select v-model="searchData.audit_id"
                              v-sf.audit_id
                              class="s-width-default"
                              :options="auditorList"
                              storageKey="warehouseAuditor"></super-select>
