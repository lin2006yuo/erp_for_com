...
//获取供应链专员
export const url_stock_lack_get_supply_chain_specialist = "get|supplier/get-supply-chain-department-Id";
export const api_stock_lack_get_supply_chain_specialist = function(){
    return http(url_stock_lack_get_supply_chain_specialist);
};
