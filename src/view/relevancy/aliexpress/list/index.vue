<template>
    <page>
        <search-card @search="search" :params="searchData" :clears="clears">
            ...
            <permission class="inline s-width-default"
                        tag="super-select"
                        :route="apis.url_get_account"
                        v-model="searchData.account_id"
                        v-sf.account_id
                        storageKey="wish-get-account"
                        :options="account">
            </permission>
            ...
            <permission class="inline s-width-default"
                        tag="super-select"
                        :route="apis.url_aliexpress_classify"
                        v-model="searchData.category_id"
                        v-sf.category_id
                        storageKey="wish-get-category-id"
                        :options="cateList">
            </permission>
            ...
            <permission class="inline s-width-default"
                        ...
                        v-model="searchData.local_category_id"
                        v-sf.local_category_id
                        storageKey="wish-get-local-category-id"
                        :options="locals_list">
            </permission>
...
<script>
    ...
    export default{
        ...
        filters:{
            ...
            filter_category_name(row){
                return !!row.alicategory ? row.alicategory.category_name_zh:"--"
            }
...
//            },
            ...
            init(){
                ...
                this.$http(api_aliexpre_list, this.searchData).then(res => {
                    ...
                    this.$set(this,'aliList',res.data);
                ...
                this.$http(api_get_categories).then(res=>{
                    ...
                    parents.forEach(res=>{
                        ...
                        res.children.forEach(row=>{
                            arr.push({id:row.id,label:row.label,value:row.id})
                        })
                    });
            ...
            getCateList(){//准入行业分类
                ...
                this.$http(api_aliexpress_classify).then(res=>{
                    this.cateList = res.map(val=>{
                        return {
                            label:val.category_name_zh,
