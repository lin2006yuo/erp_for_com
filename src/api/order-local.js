...
//锁定库存
export const url_orders_lock_inventory = "post|stock-orders/lock-inventory";
export const api_orders_lock_inventory = function(data){
    return http(url_orders_lock_inventory,data)
};
//释放内存
export const url_orders_release_inventory = "post|stock-orders/release-inventory";
export const api_orders_release_inventory = function(data){
    return http(url_orders_release_inventory,data)
};
//获取店铺list
...
//计算计抛重量和运费
export const url_orders_calculate_estimated_fee = "post|orders/calculate-estimated-fee";
export const api_orders_calculate_estimated_fee = function (data) {
    return http(url_orders_calculate_estimated_fee,data);
};
