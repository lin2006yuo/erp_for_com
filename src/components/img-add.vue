            ...
            <div style="position: relative">
                <drag-drop tag="ul" class="image-thums im" v-model="imgs">
                    <li :style="imageStyle"
                        ...
                        <div v-if="index===0&&flag_type==='mian-pic'" class="mian-pic" :title="$t('ymx-list.mImage')"></div>
                        <div v-if="index===0&&flag_type==='market-pic'" class="market-pic" title="营销图"></div>
                        <img v-lazy="url_join(image,picSize)"
...
//            },
            ...
            url_join(image, size = this.picSize) {
                let path = image.path || image.url ;
