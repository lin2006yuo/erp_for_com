...
/*速卖通 每日刊登列表*/
export const url_publish_express_everyday_publish = "get|publish/express/everyday-publish";
export const api_publish_express_everyday_publish = function(data){
    return http(url_publish_express_everyday_publish,data);
};
...
/*速卖通 每日刊登导出*/
export const url_published_express_export = "get|publish/express/everyday-publish-export";
export const api_published_express_export = function(data){
    return http(url_published_express_export,data)
};

/*本地sku搜索平台sku信息*/
export const url_sku_code_search = "post|listing/aliexpress/sku-code-search";
export const api_sku_code_search = function(data){
    return http(url_sku_code_search,data);
};

/* 同步分类属性 */
export const url_sync_category_attr = 'get|publish/express/sync-category-attr/:id';
export const api_sync_category_attr = function (id) {
    return http(Url2(url_sync_category_attr,{id:id}));
};

/*未刊登 跌价信息接口 */
export const url_goods_discount = "get|goods-discount";
export const api_goods_discount = function(data){
    return http(url_goods_discount,data);
};
