    ...
    <page class="p-index">
        ...
        <div class="row mt-xs ml-sm">
            ...
            <permission tag="ElButton"
                        ...
                        size="mini"
                        type="primary"
                        :route="apis.url_post_import_shift"
                        @click="import_shift">Excel导入移库</permission>
        </div>
        <el-table
...
<script>
    ...
    import {api_post_batch_shift, url_post_batch_shift, api_post_import_shift, url_post_import_shift} from '@/api/warehouse-cargo-shift';
    import {
