...
export const api_get_development = function(data){
    return http(url_get_development,data,{
        contentType:'application/x-www-form-urlencoded',
        timeout:INFINITE
    });
};
//获取跌价
export const url_get_discount='get|goods-discount';
export const api_get_discount=(data)=>{
  return http(url_get_discount,data);
};
//侵权词汇
export const url_infringement='get|infringement-vocabulary';
export const api_infringement=()=>{
    return http(url_infringement);
}
