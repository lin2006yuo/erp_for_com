<template>
    <page class="channel-profit">
        <search-module @init-data="init_data" ref="search_module" :channel-id="13"></search-module>
...
<script>
    import {api_report_jumia} from  '@/api/report-channel'
        ...
        data(){
            return{
                ...
                header: [
                    ...
                    {label:'美元汇率',size:100, value: 'rate_USD'},
                    {label:'售价奈拉',size:100, value: 'selling_price', handle: this.handle_number},
                    {label:'奈拉汇率',size:100, value: 'rate', handle: this.handle_number},
