...
<script>
    import {api_get_ebay_site,api_edit_combList,api_get_combs,api_get_account,api_delete_promotion} from '../../../../api/ebay-kandeng-public-module';
    ...
    export default{
        ...
        computed:{
            ...
            c_accountList(){
                let arr = window.clone(this.accountsList);
        ...
        methods:{
            ...
            init(){
                let params = {
                    ...
                    siteId:this.searchData.site_id,
                    moduleName:this.searchData.name.trim(),
                    creatorName:this.searchData.creator
                };
                this.loading = true;
                this.$http(api_get_combs,params).then(res=>{
                    this.loading = false;
            ...
            edit_model(id){
                ...
                this.$http(api_edit_combList,params).then(res=>{
                    this.add_edit_form = window.clone(res);
                    this.$nextTick(()=>{
                        this.add_edit_form.ebay_account = res.ebay_account;
                        this.add_edit_form.sale = res.sale;
                        this.add_edit_form.bargaining=res.bargaining;
                        this.add_edit_form.choice=res.choice;
                        this.add_edit_form.exclude=res.exclude;
                        this.add_edit_form.receivables = res.receivables;
                        this.add_edit_form.trans = res.trans;
                        this.add_edit_form.returngoods = res.returngoods;
                    })
                }).catch(code=>{
                    console.log("code",code);
                });
