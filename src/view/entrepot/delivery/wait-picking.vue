    ...
    <el-row class="p-table-list">
        <mailing-method ref="mailing" @left-show-change="$listeners['left-show-change']">
            ...
            <div style="line-height:26px;float:right" slot="other">
                <color-tip></color-tip>
                <!--<permission tag="superSelect"
                            class="inline"
                            v-model="warehouse_id"
                            @change="change_todepot"
                            :options="changeWarehouses"
                            storage-key="deliveryWarehouse"
                            :route="apis.url_entrepot_depot"></permission>-->
...
<script>
    ...
    export default {
        ...
        components: {
            ...
            superSelect: require('@/global-components/super-select.vue').default,
        }
    }
</script>
