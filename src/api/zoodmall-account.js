...
//zoodmall 日志
export const url_zoodmall_account_log = "get|zoodmall-account/log/:id";
export const api_zoodmall_account_log = function(id){
    return http(Url2(url_zoodmall_account_log,{id:id}));
};
