        ...
        data() {
            return {
                ...
                productivityColumn: [
                    ...
                    {label: '拆包统计', value: 'unpack_store_quantity', operate: true, use: 'unpack-store'},
        ...
        methods: {
            ...
            async init_detail() {
                try {
                    ...
                    if (this.apiReport === 'get|return-wait-shelf') Object.assign(data, {date_end: datef('YYYY-MM-dd', Date.now() / 1000)})
                    if (this.putaway !== '') {
        ...
        computed: {
            ...
            detailsColumn() {
                switch (this.use) {
                    ...
                    case 'picking':
                        return [
                            {label: '操作人员', value: 'operator', width: 95},
                            {label: '下架次数', value: 'times', width: 93},
                            {label: 'SKU品种数', value: 'type_quantity', width: 98},
                            {label: '单品单件数', value: 'single_single_quantity', width: 100},
                            {label: '单品多件数', value: 'single_more_quantity', width: 100},
                            {label: '多品数', value: 'more_quantity', width: 85},
                            {label: 'SKU总数量', value: 'quantity', width: 98}
                        ];
                    case 'unpack-store':
                        return [
                            {label: '拆包员', value: 'operator'},
