<template>
    <page-dialog :title="titleData" v-model="dialogVisible"
                 :close-on-click-modal="false">
        <el-form label-width="100px" :rules="rules" :model="form" ref="forms1" v-loading="loading">
            <el-row>
                <el-col :span="16">
            ...
            <el-row>
                <el-form-item label="采购员：" >
                    <!--<el-select class="inline" ref="purchaserId"-->
                        ...
                        <!--</el-option>-->
                    <!--</el-select>-->
                    <super-select v-model="form.purchaser_id" class="inline"
                                  ref="purchaserId" v-if="edit"
                                  storageKey="purchasers" :options="purchasers"></super-select>
        ...
        computed: {
            ...
            purchaser(){
                let find=this.purchasers.find(row=>{
                    return  row.value===this.form.purchaser_id
                });
                if(!!find){
                    return find.label
                }
