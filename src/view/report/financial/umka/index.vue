<template>
    <page class="channel-profit">
        <search-module @init-data="init_data" ref="search_module" :channel-id="14"></search-module>
...
<script>
    import {api_report_umka} from  '@/api/report-channel'
