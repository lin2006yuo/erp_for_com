        ...
        >
            ...
            <template v-for="(order,index) in tableData.list">
                <tr>
                    ...
                    <!--物流商-->
                    <td width="120">
                        <ui-tip :content="order.carrier" :width="79"></ui-tip>
                    </td>
                    <!--邮寄方式-->
                    <td width="300">
                    ...
                    <!--收款费用（CNY）-->
                    <td width="120">
                        <ui-tip :content="order.receipt_fee | toFixed2" :width="89"></ui-tip>
                    </td>
                    <!--商品成本-->
                    <td width="100">
                    ...
                    <!--转运费-->
                    <td width="80">
                        <ui-tip :content="order.trans_shipping_fee | toFixed2" :width="79"></ui-tip>
                    </td>
                    <!--估算邮费-->
                    <td width="100">
