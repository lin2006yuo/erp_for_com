            ...
            <div class="mb-mini">
                ...
                <label-item label="账号简称：" class="ml-sm">
                    <super-select
                        ...
                        :options='accountList'
                    ></super-select>
                    <!--<el-select class="inline s-width-default"          旧版-->
                               <!--filterable clearable-->
                               <!--:disabled="accountList.length<=1"-->
                               <!--:placeholder="accountHolder"-->
                               <!--v-sf.account_id-->
                ...
                <label-item label="操作人：" class="ml-sm">
                    <super-select
                        ...
                        :is-paging="true"
                        :adjustStructure="sale_fix_result"
                        :remoteRequestHttp="remoteRequestHttps"
                    ></super-select>
                    <!--<param-account-->
                            <!--class="inline s-width-default"-->
                            <!--ref="paramSale"-->
...
//            },
            "form.channel"(val){
                this.siteList = [];
                this.accountList = [{label:"",value:0}];
        ...
        methods:{
            ...
            remoteRequestHttps(){
                return http("get|user/virtual/staffs",{content:''})
            },
            remoteRequestHttp(){
            ...
            get_site(channel_id){
                if(!channel_id)return this.siteList = [];
