...
export const api_get_stocking_advice = function(data) {
    return http(url_get_stocking_advice,data,{
...
// 判断 有没有sku采购价格为0的数据 (0 = 没有sku采购价格为0的数据， 1 = 存在采购价格为0的数据)
export const url_stocking_check_purchase_price = "put|stocking-advice/check-purchase-price";
export const api_stocking_check_purchase_price = function(data) {
    return http(Url2(url_stocking_check_purchase_price),data);
};
//获取备货计划导出列表
