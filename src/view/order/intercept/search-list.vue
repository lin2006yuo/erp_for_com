            ...
            <label-item label="发货仓库：">
                <super-select
                    storageKey="order_warehouse"
                     class="inline mr-sm" style="width:120px"
...
<script>
    ...
    import {api_get_shipping,api_account_list} from '../../../api/common'
//    import {mapGetters} from 'vuex';
	export default{
        ...
        methods:{
            ...
            get_site(channel_id){
                if(!channel_id)return  this.accountList = [];
...
//            ...mapGetters({getParamAccount:'api/getParamAccount'}),
            accountPlaceholder(){
                if(this.accountParam.channel_id<=0){
                    return "请先选择平台";
