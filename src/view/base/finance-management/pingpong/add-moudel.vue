    ...
    <page-dialog class="c-card-search-order" :title="title"
        ...
        <el-form :model="addData"
            ...
            <el-form-item label="站点：" prop="site_code" :show-message="!!siteOptions.length">
                <el-col :span="20">
                    <el-select :disabled="!siteOptions.length"
                               ...
                               class="inline local-order-input-no-margin local-order-self-width merge-able"
            ...
            <el-form-item label="收款账号：" prop="account_number">
                <el-col :span="20">
                    <el-input v-model="addData.account_number"
                              class="inline"
...
<script>
    ...
    import {api_pingpong_add,api_channels_account} from '@/api/pingpong';
            ...
            keep(){
                this.$refs.addData.validate((bool)=>{
                    if(bool){
                        ...
                        this.$http(api_pingpong_add,data).then(succ=>{
