<template>
    <div class="c-table-data">
        <el-table
            ...
            <el-table-column label="操作" inline-template min-width="200">
                <div>
                    ...
                    <permission
                        tag="span"
                        :route="apis.url_cd_account_log">|</permission>
                    <permission tag="span"
                                :route="apis.url_cd_account_log"
                                class="operate"
...
<script>
    import {api_system_states,api_cd_account_check,url_cd_account_log} from '@/api/cd-account';
    export default {
        permission: {
            url_cd_account_log
        },
