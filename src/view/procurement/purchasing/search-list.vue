    ...
    <div class="p-search-purchasing">
        <search-card @search="search_list" :params="searchParams" :clears="clears">
            ...
            <div>
                ...
                <el-select class="inline input-no-margin s-width-large" v-sf.sku_status
                           v-model="searchParams.sku_status"
                           multiple filterable
                ...
                <el-select class="inline input-no-margin"
                           v-sf.purchaser_id
                           style="width: 14%"
                           :value="searchParams.purchaser_id"
                           multiple filterable @change="change_buyer"
                           @remove-tag="remove_tag" placeholder="请选择">
                    <el-option
                            v-for="item in buyer"
                            :key="item.id"
                            ...
                            :value="item.id">{{item.realname}}&nbsp;&nbsp;<div class="inline" style="color: red;float: right;margin-right: 35px;">{{item|filterTime}}</div>
                    </el-option>
                </el-select>
            </div>
            <div class="mt-mini inline">
                ...
                <label class="inline" title="请选择仓库">是否空卖：</label>
                <el-select v-model="searchParams.pre_sale"
                           v-sf.pre_sale
                           @change="change_sale_status"
...
<script>
    ...
    export default{
        ...
        methods: {
            ...
            change_sale_status(){
                this.searchData.pre_sale = this.searchParams.pre_sale;
            },
