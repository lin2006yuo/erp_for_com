    ...
    <page-dialog class="c-card-search-order" :title="title"
        ...
        <el-form :model="editData"
            ...
            <el-form-item label="收款账号：" prop="lianlian_account">
                <el-col :span="20">
                    <el-input v-model="editData.lianlian_account"
                              v-if="senseDisabled"
                              class="inline"
                              placeholder="请输入"></el-input>
                    <span v-else>{{editData.lianlian_account}}</span>
                </el-col>
            </el-form-item>
            <el-form-item label="收款人名称：" prop="lianlian_name">
                <el-col :span="20">
                    <el-input v-model="editData.lianlian_name"
                              v-if="senseDisabled"
                              class="inline"
                              placeholder="请输入"></el-input>
                    <span v-else>{{editData.lianlian_name}}</span>
                </el-col>
            </el-form-item>
...
<script>
    ...
    import {api_lianlianpay_save,api_channels_account} from '@/api/lianlianpay';
            ...
            keep(){
                this.$refs.editData.validate((bool)=>{
                    if(bool){
                        ...
                        this.$http(api_lianlianpay_save,this.editData.id,this.editData).then(succ=>{
