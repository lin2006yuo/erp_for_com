...
//aliexpress 日志
export const url_aliexpress_account_log = "get|aliexpress-account/log/:id";
export const api_aliexpress_account_log = function(id) {
    return http(Url2(url_aliexpress_account_log, {id: id}));
};
