...
//获取账号简称
export const url_get_myMall_cuuounts='get|publish/pandao/accounts';
export const api_get_myMall=function (data) {
    return http(url_get_myMall_cuuounts,data)
}
//在售批量导出
export const url_pandao_download='post|publish/pandao/export';
export const api_pandao_download=(data)=>{
    return http(url_pandao_download,data);
}
