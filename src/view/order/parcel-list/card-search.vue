            ...
            <div class="mb-xs">
                ...
                <label-item label="账号简称：" class="ml-sm">
                    ...
                    <select-account
                        ...
                        :param="{channel_id: form.channel_id, site_code: form.site_code}"
                        type="account"
                    ></select-account>
                </label-item>
                ...
                <label-item label="物流状态：" class="ml-sm">
                    <el-select v-sf.logistics_state v-model="form.shipping_type" class="width-xs">
...
<script>
    ...
    import {
        ...
        api_distribution_type_info, api_picking_type_info, api_packing_type_info, api_shipping_status
    } from '@/api/common.js';
...
//                日期类型（shipping_time -发货时间  pay_time 支付时间）
        ...
        methods: {
            ...
            get_shipping_status() {
                this.$http(api_shipping_status).then(res => {
                    this.logisticsList = res.map(v => {
                        return {
                            value: v.code,
                            label: v.label
                        }
