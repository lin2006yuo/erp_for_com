    ...
    <div class="wish-wishPublish-list">
        ...
        <ui-table
            ...
            :heads="[
                        ...
                        {label:'销售员',width:6},
                        {label:'审核状态',width:5},
                        {label:'已收藏',width:5,isSort:true,order_type:'number_saves'},
                        {label:'已售量',width:5,isSort:true,order_type:'number_sold'},
                        {label:'退单量/率',width:6},
                        {label:'修改状态',width:6},
            ...
            <template v-for="(data, index) in tableData">
                <tr :class="[data.show ? 'active' : '',data.heighLight?'active-color':'',data.listing_status===5?'redborder':'']" @click="addClass(index)"
                    ...
                    <td><ui-tip :content="data.shop_code" :width="80"></ui-tip></td>
                    ...
                    <td>{{data.number_refunds}}/{{data.refund_rate}}</td>
                    <td>
