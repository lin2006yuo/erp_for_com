...
//获取仓库多品分拣人信息
export const url_get_twice_picker = "get|warehouse-area/:warehouse_id/picker";
export const api_get_twice_picker = function (warehouse_id, data) {
    return http(Url2(url_get_twice_picker, {warehouse_id}), data);
};
//设置仓库多品分拣人信息
export const url_set_twice_picker = "put|warehouse-area/:warehouse_id/picker";
export const api_set_twice_picker = function (warehouse_id, data) {
    return http(Url2(url_set_twice_picker, {warehouse_id}), data);
};