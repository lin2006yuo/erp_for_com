<template>
    <page class="channel-profit">
        <search-module @init-data="init_data" ref="search_module" :channel-id="15"></search-module>
        <request-button
                :disabled="hasData"
...
<script>
    import {api_report_newegg} from  '@/api/report-channel'
    ...
    export default{
        ...
        data(){
            return{
                apiTableData: api_report_newegg
            }
        }
    }
</script>
