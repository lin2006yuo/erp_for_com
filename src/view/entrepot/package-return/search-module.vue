        ...
        <div>
            <label-item label="请选择仓库：" class="mb-xs mt-sm">
                <super-select v-model="warehouse_id" class="inline width-sm"
                              :options="warehouses"
                              @change="change_depot" storage-key="packageReturnWarehouse"></super-select>
            ...
            <el-row class="mb-mini">
                ...
                <label-item label="平台：">
                    <!--<super-select v-model="searchData.channel_id"
                                  ...
                                  storage-key="channelAll"
                                  :options="channelList"
                                  class="width-sm"
                                  v-sf.channel_id></super-select>-->
                ...
                <label-item label="站点：" class="ml-sm">
                    <super-select :disabled="siteOptions.length<=1"
                                  class="width-sm"
                                  filterable clearable
                                  v-sf.site_code
                                  :storage-key="`${searchData.channel_id}Site`"
                                  :options="siteOptions"
                                  :placeholder="sitePlaceholder"
                                  v-model="searchData.site_code"></super-select>
                ...
                <label-item label="账号简称：" class="ml-sm">
                    <super-select :disabled="accoutOptions.length<=1"
                                  :options="accoutOptions"
                                  filterable clearable
                                  :storage-key="`${searchData.channel_id}_${searchData.site_code}_account`"
                                  :placeholder="accountPlaceholder"
                                  v-sf.account_id
                                  class="s-width-small"
                                  v-model="searchData.account_id"></super-select>
                ...
                <label-item>
                    ...
                    <el-input v-model="searchData.snText" :placeholder="`请输入${changeLabel}...`" class="ml-xs enter-result" @keydown.enter.native="init"></el-input>
                </label-item>
                ...
                <label-item label="SKU：" class="ml-sm">
                    <order-input class="width-super"
                                 ...
                                 v-sf.skus></order-input>
                </label-item>
            </el-row>
            <el-select v-model="searchData.snUser" class="inline width-xs">
    ...
    export default {
        ...
        methods: {
            ...
            init(){
                ...
                if (this.searchData.skus) {
                    searchData.skus = this.searchData.skus.split('\n').filter(row => !!row).map(row => row.trim());
                }
