<template>
    <div class="c-kindeditor">
        ...
        <select-img v-model="dialog"
                    ...
                    @call-back="call_back"
                    :id="id"></select-img>
        <editor :id="editorId" :height="height"
                :width="width" :content="editorText"
                :items="curItems"
...
<style lang="stylus">
    .new-ke-kindeditor{
        font:18px/1.5 Arial, "sans serif",tahoma,verdana,helvetica !important;
        td{
            font:18px/1.5 Arial, "sans serif",tahoma,verdana,helvetica !important;
        }
    }
...
//                }
        ...
        mounted(){
            if(this.editorText&&this.canReplace){
                let reg = /(\n)|(\r)/g;
                let Symbol = this.enterChange?"<br/>":"";
                let _editorText = this.editorText.replace(reg,Symbol)
