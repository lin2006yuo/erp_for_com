    ...
    <el-row class="p-picture-describe-ali">
        ...
        <div class="p-picture" >
            <el-form :model="pictureData" ref="picture" label-width="130px">
                ...
                <!--<el-form-item label="营销图：" v-if="pictureData.is_market_image === 1">
                    <img-add v-model="pictureData.market_images"
                             :is-kandeng="true"
                             :id="especialIds"
                             @save-meitu="saveMarketPic(pictureData.market_images,params)"
                             :channel_id="4"
                             :channel-id="4"
                             :showSwatchImg="false"
                             :defaultRandom="!trueId||isCopy"
                             :show-random-btn="!trueId||isCopy"
                             :base-url="baseUrl"
                             flag_type="market-pic"
                             :img-number=6>
                    </img-add>
                    <div class="p-upload__notice">营销图有助于提升转化，应用于搜索和推荐场景，尺寸必须为750*1000</div>
                </el-form-item>-->
                ...
                <el-form-item label="内容描述：" class="pictures" required>
...
//            },
            ...
            saveMarketPic(imageList,obj){
                if(imageList[obj.curIndex]){
                    imageList[obj.curIndex].url = obj.newPath;
                    imageList[obj.curIndex].path = obj.newPath;
                    imageList[obj.curIndex].image_type = 1;
                }
            },
...
//                this.imgs.push(item);
            ...
            data_creat(){
                ...
                str=str.replace(/(&nbsp;)/g," "); //移动端所有字符 留有空格间隙
                //截掉table字符串
                let table=/<table[^>]*>/gi;
