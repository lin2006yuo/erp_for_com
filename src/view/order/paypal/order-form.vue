            ...
            <tabs>
                <tab-head :navs="[{label:'订单基本信息',action:''},{label:'产品信息',action:'product'},{label:'收货人信息',action:'buyinfo'}]">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">关联交易号</span>: <span class="detail">{{checkList.reference_id}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
            ...
            <!--  产品信息  -->
                <tab-item id="product" label="产品信息">
                    <el-table :data="checkList.items" border>
                        <el-table-column prop="item_number" label="item_number"></el-table-column>
                        <el-table-column prop="item_name" label="产品名称"></el-table-column>
                        <el-table-column prop="item_quantity" label="数量"></el-table-column>
                    </el-table>
                </tab-item>
            <!--  收货人信息  -->
