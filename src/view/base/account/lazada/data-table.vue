    ...
    <el-row class="p-lazada-table">
        <div>
            <el-table v-resize="{height:41}"
                ...
                <el-table-column width="100" inline-template label="简称" sortable>
                ...
                <el-table-column inline-template
                                 ...
                                 sortable
                                 align="center">
                    <ui-tip :content="row.token_expire_time | filterRegisterTime" :width="98" v-copy></ui-tip>
                </el-table-column>
                ...
                <el-table-column width="90" label="Lazada状态" align="center"  inline-template>
...
<script>
    import {
        ...
        url_get_token,url_account_log,
        api_get_token, api_account_log} from '@/api/lazada';
	...
	export default{
        ...
        methods:{
            selects(row){
                ...
                let buttons = [
                    {label:'查看',value:0, apis:'url_get_lazada_account'},
                    {label:'编辑',value:1, apis:'url_lazada_account_edit'},
                    {label:is_authorization,value:2, apis:'url_lazada_authorization'},
                    // {label:'账号负责人',value:3, apis:'url_add_member'},
                    {label:'更新token',value:4, apis:'url_get_token'},
...
//            添加成员事件
            add_member(row){
                ...
                this.api_add_member({channel_id:6,account_id:row.id});
            },
//            添加成员
            api_add_member(val){
