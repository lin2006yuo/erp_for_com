        ...
        <div>
            <div class="upload-demo">
                <div class="el-upload el-upload--text fl">
                    <div class="operate" style="display:inline-block" @click="$refs.input.click();"
                    ...
                    <ul class="el-upload-list el-upload-list--text">
                        <li class="el-upload-list__item is-success" v-for="image in images">
                            <span class="el-upload-list__item-name"><i
                                class="el-icon-document"></i>{{image.name}}</span>
        ...
        methods: {
            ...
            handleChange(ev) {
                ...
                fileArr.forEach(file => {
                    if ((/\.(zip$)/.test(file.name)) || /\.(rar$)/.test(file.name)) {
                        this.file_push(file);
                    } else {
