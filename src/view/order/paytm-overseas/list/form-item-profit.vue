            ...
            <tbody>
                <template>
                    <tr>
                        ...
                        <!--货品金额-->
                        <td class="income">{{form.income.pay_symbol}} {{form.income.goods_amount|emptyByDefault}}</td>
                        <!--实付运费-->
                        <td class="income">{{form.income.pay_symbol}} {{form.income.providers_fee|emptyByDefault}}</td>
                        <!--调整金额-->
                        <td class="income">{{form.income.pay_symbol}} {{form.income.adjust_amount|emptyByDefault}}</td>
                        <!--P卡费用-->
                        <td class="expend">--</td>
                        <!--渠道收费-->
                        <td class="expend">{{form.expend.cost_symbol}} {{form.expend.channel_cost|emptyByDefault}}</td>
                        <!--货品成本-->
                        <td class="expend">{{form.expend.cost_symbol}} {{form.expend.product_cost|emptyByDefault}}</td>
                        <!--paypal费用-->
                        <td class="expend">--</td>
                        <!--头程运费-->
                        <td class="expend">{{form.expend.cost_symbol}} {{form.expend.first_fee|emptyByDefault}}</td>
                        <!--头程报关费-->
                        <td class="expend">{{form.expend.cost_symbol}} {{form.expend.tariff|emptyByDefault}}</td>
                        <!--包装成本-->
                        <td class="expend">{{form.expend.cost_symbol}} {{form.expend.package_fee|emptyByDefault}}</td>
                        <!--估计运费-->
                        <td class="expend">{{form.expend.cost_symbol}} {{form.expend.shipping_fee|emptyByDefault}}</td>
                        <!--利润-->
