...
<script>
    import {api_ebay_list} from '@/api/selling-profit';
        ...
        computed: {
            tableColumns() {
                return [
                    ...
                    {label: '销售主管', value: 'sale_director', hide: this.is_salesman},
                    ...
                    {label: 'PayPal费用', value: 'paypal_fee', width: '100', handle: this.toFixed2},
                    {label: '货币转换费', value: 'currency_transform_fee', handle: this.toFixed2},
                    {label: '物流费用', value: 'shipping_fee', handle: this.toFixed2},
                    // {label: '包装费用', value: 'package_fee', handle: this.toFixed2},
                    {label: '国内采购运费', value: 'first_fee', handle: this.toFixed2, width: 120},
                    ...
                    {label: '补贴后利润', value: 'after_subsidy_profits', handle: this.toFixed2},
                    {label: '补贴后利润率', value: 'after_subsidy_profits_rate', handle: this.toFixed2, width: '120'},
                ]
            },
        },
        components: {
