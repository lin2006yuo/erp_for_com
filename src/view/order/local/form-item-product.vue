            ...
            <template v-for="(item,index) in form">
                ...
                <template v-if="item.detail_goods.length>0"
                    ...
                    <tr v-if="subitem.message">
                        <td :class="[curStatus?'red':'','t-right']" colspan="10">
                            ...
                            <el-popover placement="left"
                                ...
                                <el-table
                                    ...
                                    <el-table-column label="采购单号" inline-template><div>PO{{row.id}}</div></el-table-column>
                                    <el-table-column label="运单号" inline-template >
                                        <div class="flex-col flex-1 row">
                                            <div v-for="(numitem,numindex) in filterData(row.is_use,'value')" :key="numindex " class="flex-1" :style="numindex>0?borderTop:''">
                                                <span class="operate" v-if="numitem.length" @click="look_logistics(numitem.join(','))">
                                                    {{numitem.join(",")}}
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <el-table-column label="包裹状态" inline-template>
                                        <div v-for="(numitem,numindex) in filterData(row.is_use,'key')" :key="numindex"  class="flex-1" :style="numindex>0?borderTop:''">
                                            <span class="operate">
                                                {{numitem}}
                                            </span>
                                        </div>
