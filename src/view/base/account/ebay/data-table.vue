    ...
    <el-row class="p-ebay-table">
        <div class="p-ebay-table-box">
            <el-table
                ...
                <el-table-column label="操作" inline-template align="center" width="410">
                    <div>
                        <permission
                                tag="span"
                        ...
                        <permission
                            tag="span"
                            :route="apis.url_ebay_account_log">|</permission>
                        <permission tag="span"
                                    :route="apis.url_ebay_account_log"
                                    class="operate"
