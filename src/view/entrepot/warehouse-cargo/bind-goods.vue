    ...
    <page-dialog class="p-bind-goods" @close="close" title="绑定货位" v-model="visible" size="small"
        ...
        <div class="mb-sm">
            ...
            <label-item label="货位：" label-width="200" v-else>
                <!--<super-select-->
                        <!--storageKey="cargoList"-->
                        <!--v-model="cargo"-->
                        <!--class="inline mb-mini"-->
                        <!--:options="cargoList"-->
                <!--&gt;</super-select>-->
                <scroll-select v-model="cargo" class="inline mb-mini"
                               textAlign="left"
                               :remote="urlValue"
                               :size="20"
                               :fix-params="fix_params_cargo"
                               :fixResult="fix_result_cargo">
                </scroll-select>
                <!--<ui-autocomplete-->
                        <!--class="inline mb-mini"-->
                        <!--v-model="cargo"-->
    ...
    export default {
        data() {
            return {
                ...
                urlValue: 'get|warehouse-cargo/recommend'
            }
        },
        mounted() {
        ...
        methods: {
            fix_params_cargo({page, pageSize, keyword}) {
            ...
            manual_bind() {
                ...
                this.$http(api_get_cargo, data).then(res => {
                    ...
                    this.cargoList = res.data.map(row => {
            ...
            query() {
                ...
                let data = {
                    ...
                    sku: skuList,
                    warehouse_area_type: this.warehouse_area_type,
                    warehouse_cargo_code: this.cargo.value
                };
