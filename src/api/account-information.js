...
export const api_get_company_nameAll  =()=>{
    return http("get|account-company/company?test");
};
...
//获取站点信息详情
export const url_get_account_site_detail = "get|account-basics/:account_id/site";
export const api_get_account_site_detail = id=> {
    return http(Url2(url_get_account_site_detail,{account_id:id}));
};

//获取批量账号状态
export const api_get_base_account_site_status =()=>{
    return http("get|account-basics/site-status/change",);
};

//获取账号状态
export const api_get_base_account_status_account =()=>{
    return http("get|account-basics/site-status");
};

//更改账号状态
export const api_update_account_status =data=>{
    return http("post|account-basics/batch/site-status",data);
};
