<template>
    <page class="p-index-inbox">
        ...
        <el-row :gutter="8">
            ...
            <el-col :span="14">
                <el-card class="right-card ebay-right-card filter-body">
                    <div style="height:99%;overflow-y:auto">
                        <div v-for="(de,de_i) in filterBody(details)" :key="de.id" v-if="details.length"
                ...
                <el-card v-loading="replayLoading" class="mt-lg" v-resize="{height:12}">
                    <div>
...
<!--                            </permission>-->
                            ...
                            <permission tag="ElButton" :route="apis.url_message_replay" size="mini" @click='replay'
                                        type="primary" class="inline">关闭
                            </permission>
                            <permission tag="ElButton" :route="apis.url_message_replay" size="mini" @click='replay'
                                        type="primary" class="inline">请求wish支持协助
                            </permission>
                        </div>
                    </el-row>
                    <div>
...
<style lang="stylus">
    .p-index-inbox {
        ...
        .right-card.ebay-right-card.filter-body {
            .primary-cta-button {
...
//                纠纷信息
        ...
        components: {
            searchList,
            uiCollapse,
            historyOrder: require('./history-order').default,
