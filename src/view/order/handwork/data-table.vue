    ...
    <div class="c-manual-orders-data-list relative">
        ...
        >
            ...
            <el-table-column label="操作" inline-template width="100px">
               <trends-select class="inline" :selects="m_options(row)"  type="primary" @trigger="cur_operate(row,$event), acction_click($event)"></trends-select>
            </el-table-column>
        </el-table>
        <el-pagination
                class="page-fixed"
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            acction_click(ev){ //让该行获得action效果
                ev=window.event||ev;
                ev.path?ev.path[7].click():ev.target.offsetParent.parentNode.click();
            },
