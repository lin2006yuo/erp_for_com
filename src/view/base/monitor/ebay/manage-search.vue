<template>
    <div class="inline">
        <label-item label="账号简称：" class="inline">
            ...
            <!--<el-select  v-model="searchData.account_id" class="inline width-xs" clearable filterable>-->
                <!--<el-option-->
                        <!--:key="item.value"-->
        ...
        <label-item label="站点：" class="inline ml-sm">
            ...
            <super-select
                v-model="searchData.site_name"
                class="inline width-xs"
                filterable
                clearable
                ref="leader"
                storage-key="ebayAccountSite"
                :options="siteLists"
            >
            </super-select>
