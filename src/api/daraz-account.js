...
//daraz   批量设置
export const url_daraz_batch_set = "post|daraz-account/batch-set";
export const api_daraz_batch_set = function(data){
    return http(url_daraz_batch_set,data);
};
//daraz 日志
export const url_daraz_account_log = "get|daraz-account/log/:id";
export const api_daraz_account_log = function(id){
    return http(Url2(url_daraz_account_log,{id:id}));
};
