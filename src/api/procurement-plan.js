...
//操作日志
export const url_purchase_plan_log= "get|purchase-plan/getLogDetail";
export const api_purchase_plan_log  = function(data) {
    return http(Url2(url_purchase_plan_log), data);
};
//批量备注
export const url_purchase_plan_batch_remark= "put|purchase-plan/batch-remark";
export const api_purchase_plan_batch_remark  = function(data) {
    return http(Url2(url_purchase_plan_batch_remark), data);
};
