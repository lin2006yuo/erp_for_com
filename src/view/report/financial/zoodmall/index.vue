<template>
    <page class="channel-profit">
        <search-module @init-data="init_data" ref="search_module" :channel-id="18"></search-module>
...
<script>
    import {api_report_zoodmall} from  '@/api/report-channel'
    ...
    export default{
        ...
        data(){
            return{
                apiTableData: api_report_zoodmall
            }
        }
    }
</script>
