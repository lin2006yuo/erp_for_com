        ...
        <el-form>
            ...
            <div class="form-item">
                ...
                <div>
                    ...
                    <div class="track-rule" v-for="(track, index) in disData.tracking_rules" :key="`track_${index}`">
                        ...
                        第 <el-input class="inline width-mini" :disabled="!editable" v-model="track.start_position"></el-input> 位 ---
                        第 <el-input class="inline width-mini" :disabled="!editable" v-model="track.end_position"></el-input> 位
                        <!-- 删除按钮 -->
                        <el-button
                        ...
                        <el-button
                            ...
                            v-if="index === (disData.tracking_rules.length - 1) && editable"
                        ></el-button>
                        <!-- 校验错误提示 -->
                    ...
                    <!-- 跟踪号添加按钮 -->
                    <el-button size="mini" icon="plus" type="primary" class="ml-sm" @click="new_track_rule()" v-if="disData.tracking_rules && !disData.tracking_rules.length && editable"></el-button>
                </div>
            </div>
            <!-- 敏感词 -->
            <div class="form-item mt-sm">
                ...
                <div class="sensitive-input-group">
                    ...
                    <!-- 敏感词添加按钮 -->
                    <el-button
                        v-else-if="!inputVisible && editable" class="button-new-tag"
                        type="primary"
                        size="mini"
                        @click="show_input"
                        icon="plus"></el-button>
