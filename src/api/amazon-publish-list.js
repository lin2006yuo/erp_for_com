...
// 跌价提示
export const url_publish_amazon_discount='get|goods-discount';
export const api_publish_amazon_discount= function(goods_id){
    return http(url_publish_amazon_discount,goods_id)
}
//获取产品标签
...
//亚马逊每日刊登 取消
export const url_publish_amazon_delete_task = 'delete|publish/amazon-task';
export const api_publish_amazon_delete_task = function(data){
    return http(url_publish_amazon_delete_task,data);
}
//亚马逊每日刊登 批量取消
export const url_publish_amazon_batch_delete_task = 'delete|publish/amazon-task/batch';
export const api_publish_amazon_batch_delete_task = function(data){
    return http(url_publish_amazon_batch_delete_task,data);
}
//
export const development_staffs = 'get|user/development/staffs';
export const api_development_staffs = function(){
    return http(development_staffs);
}
export const sales_staffs = 'get|user/sales/staffs';
export const api_sales_staffs = function(){
    return http(sales_staffs);
}
//侵权词 提示
export const url_publish_amazon_tort_tip = 'get|infringement-vocabulary';
export const api_publish_amazon_tort_tip = function(){
    return http(url_publish_amazon_tort_tip);
}
//每日刊登-任务转接
export const url_amazon_task='post|publish/amazon-task/transfer';
export const api_amazon_task=(data)=>{
    return http(url_amazon_task,data)
}
//每日刊登
export const url_amazon_export='get|publish/amazon-task/export';
export const api_amazon_export=(data)=>{
    return http(url_amazon_export,data);
}
