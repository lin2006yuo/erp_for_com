<template>
    <div>
        <published-draft-search
                ...
                :clearsData="clearsData"></published-draft-search>
...
<script>
    import {api_amazon_draft_delete,url_amazon_draft_delete,api_amazon_draft_list} from '@/api/amazon-publish-list';
    export default{
        permission:{
        ...
        methods: {
            ...
            init(){
                ...
                if(this.searchData.snType!=='title' && this.str){
                    params.content =this.str.trim();
                }
                this.loading = true;
