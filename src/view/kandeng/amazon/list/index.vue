<template>
    <page>
        <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-tab-pane :label="$t('ymx-list.dailyPublished')" name="6">
                <daily-published ref="daily" v-if="activeName==='6'" :siteList="siteList"></daily-published>
            </el-tab-pane>
        </el-tabs>
    </page>
</template>
...
<script>
    ...
    export default{
        page: {},
        refresh(){
           let refs=['has',"not",'queue',"error","draft","daily"];
            this.$nextTick(()=>{
        ...
        components: {
             ...
             dailyPublished:require('./daily-published.vue').default   //每日刊登
        }
    }
</script>
