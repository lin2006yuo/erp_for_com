    ...
    <el-row class="c-btnlist-middle">
        <label-items label="">
            ...
            <permission tag='ElButton' type="primary" size="mini"
                        :route="apis.url_batch_stopped_sku"
                       @click.native="batch_stop_sell">批量停售SKU</permission>
        ...
        <batch-stop-sell v-model="stopSell"></batch-stop-sell>
...
<script>
    ...
    import{url_publish_add_baseinfo,url_update_excel,url_goods_import_update,
        url_export,url_batch_catch_photo,url_goods_set_purchaser,url_batch_stopped_sku,
    ...
    export default{
        ...
        components: {
            ...
            batchStopSell:require('./batch-stop-sell').default,
        }
    }
</script>
