...
// 获取订单状态
export const url_paypal_transaction_status = "get|paypal-orders/transaction-status"
export const api_paypal_transaction_status = function(){
    return http(url_paypal_transaction_status);
};
