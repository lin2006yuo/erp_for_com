...
import {url_stocking_audit} from "@/api/stocking";
/*
 *ebay 公用模块接口
 */
/*保存公用模板*/
...
// 每日刊登获取列表
export const publish_ebay_daily_publish = "get|publish-ebay/daily-publish";
export const api_ebay_daily_publish = function(data){
    return http(publish_ebay_daily_publish,data)
};
//获取分类
...
// 获取部门销售员
export const url_department_user= "get|department/:id/department-users";
export const api_department_user = function (id) {
    return http(Url2(url_department_user, {id: id}));
};
//批量转接
export const url_daily_publish_seller= "post|publish-ebay/daily-publish/seller";
export const api_daily_publish_seller = function(data){
    return http(url_daily_publish_seller,data)
};
//每日刊登 导出
export const url_ebay_daily_publish_export= "get|publish-ebay/daily-publish/export";
export const api_ebay_daily_publish_export = function(data){
    return http(url_ebay_daily_publish_export,data)
};
//获取跌价详情
export const url_ebay_goods_discount= "get|goods-discount";
export const api_ebay_goods_discount = function(data){
    return http(url_ebay_goods_discount,data)
};
//获取侵权词汇管理（页面）
export const url_infringement_vocabulary= "get|infringement-vocabulary";
export const api_infringement_vocabulary = function(){
    return http(url_infringement_vocabulary)
};
//ebay账号表现 获取整体状态列表
export const url_account_performance= "get|ebay/account-performance";
export const api_account_performance = function(data){
    return http(url_account_performance,data)
};
//账号表现 批量同步
export const url_account_performance_sync_batch= "post|ebay/account-performance/sync/batch";
export const api_account_performance_sync_batch = function(data){
    return http(url_account_performance_sync_batch,data)
};
// 获取综合表现状态
export const url_account_performance_ltnp= "get|ebay/account-performance/:account_id/ltnp";
export const api_account_performance_ltnp = function(account_id){
    return  http(Url2(url_account_performance_ltnp, {account_id: account_id}));
};
// 非货运表现
export const url_account_performance_tci= "get|ebay/account-performance/:account_id/tci";
export const api_account_performance_tci = function(account_id){
    return  http(Url2(url_account_performance_tci, {account_id: account_id}));
};
//非货运表现问题刊登列表 ebay/account-performance/:account_id/tci
// export const url_account_performance_tci= "get|ebay/account-performance/:account_id/tci";
// export const api_account_performance_tci = function(account_id){
//     return  http(Url2(url_account_performance_tci, {account_id: account_id}));
// };
...
//获取货运问题刊登列表1-8周
export const url_account_ship_defect_one= "get|ebay/account-performance/:account_id/ship-defect1-8";
export const api_account_ship_defect_one = function(account_id){
    return  http(Url2(url_account_ship_defect_one, {account_id: account_id}));
};
//获取货运问题刊登列表5-12周
export const url_account_ship_defect_five= "get|ebay/account-performance/:account_id/ship-defect5-12";
export const api_account_ship_defect_five = function(account_id,data){
    return  http(Url2(url_account_ship_defect_five, {account_id: account_id}),data);
};
//获取物流标准政策
export const url_account_shipping_policy= "get|ebay/account-performance/:account_id/shipping-policy";
export const api_account_shipping_policy = function(account_id){
    return  http(Url2(url_account_shipping_policy, {account_id: account_id}));
};
//获取SpeedPAK物流表现状态
export const url_account_speed_pak= "get|ebay/account-performance/:account_id/speed-pak";
export const api_account_speed_pak = function(account_id){
    return  http(Url2(url_account_speed_pak, {account_id: account_id}));
};
//SpeedPAK 物流管理方案及其他符合政策要求的物流服务使用状态相关交易下载
export const url_account_speed_pak_download= "get|ebay/account-performance/:account_id/speed-pak-list/download";
export const api_account_speed_pak_download = function(account_id){
    return  http(Url2(url_account_speed_pak_download, {account_id: account_id}));
};
//卖家设置SpeedPAK物流选项与实际使用物流服务不符表现相关交易下载
export const url_account_speed_misuse_download= "get|ebay/account-performance/:account_id/speed-pak-misuse/download";
export const api_account_speed_misuse_download = function(account_id){
    return  http(Url2(url_account_speed_misuse_download, {account_id: account_id}));
};
//SpeedPAK 物流管理方案及其他符合政策要求的物流服务使用状态相关交易下载
export const url_account_speed_list_download= "get|ebay/account-performance/:account_id/speed-pak-list/download";
export const api_account_speed_list_download = function(account_id){
    return  http(Url2(url_account_speed_list_download, {account_id: account_id}));
};
//
export const url_account_speed_warehouse_download= "get|ebay/account-performance/:account_id/warehouse/download";
export const api_account_speed_warehouse_download = function(account_id){
    return  http(Url2(url_account_speed_warehouse_download, {account_id: account_id}));
};
// 获取海外仓标准表现状态
export const url_account_acct_list_download= "get|ebay/account-performance/:account_id/acct-list";
export const api_account_acct_list_download = function(account_id){
    return  http(Url2(url_account_acct_list_download, {account_id: account_id}));
};
//商业计划追踪
export const url_account_acct_pgc_tracking= "get|ebay/account-performance/:account_id/pgc-tracking";
export const api_account_acct_pgc_tracking = function(account_id){
    return  http(Url2(url_account_acct_pgc_tracking, {account_id: account_id}));
};
//获取待处理刊登列表
export const url_account_qclist= "get|ebay/account-performance/:account_id/qclist";
export const api_account_qclist = function(account_id,data){
    return  http(Url2(url_account_qclist, {account_id: account_id}),data);
};
//获取待处理刊登列表
export const url_account_seller_inr= "get|ebay/account-performance/:account_id/seller-inr";
export const api_account_seller_inr = function(account_id,data){
    return  http(Url2(url_account_seller_inr, {account_id: account_id}),data);
};
//获取非货运表现问题刊登列表
export const url_account_nonshipping_defect= "get|ebay/account-performance/:account_id/nonshipping-defect";
export const api_account_nonshipping_defect = function(account_id,data){
    return  http(Url2(url_account_nonshipping_defect, {account_id: account_id}),data);
};
//获取货运表现状态 
export const url_account_performance_ship= "get|ebay/account-performance/:account_id/ship";
export const api_account_performance_ship = function(account_id){
    return  http(Url2(url_account_performance_ship, {account_id: account_id}));
};
