<template>
   <div>
       ...
       >
           ...
           <el-table-column  label="采购员" prop="purchaser" width="170" >

           </el-table-column>
           <el-table-column label="SKU查重文员"  prop="sku_checking" width="170" >

           </el-table-column>
           <el-table-column label="操作" inline-template>
               <div>
                   <span class="operate" @click="edit(row)">绑定采购员</span>
                   &nbsp;|&nbsp;
                   <span class="operate" @click="check(row)" >绑定SKU查重文员</span>
                   &nbsp;|&nbsp;
