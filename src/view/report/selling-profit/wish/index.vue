...
<script>
    import {api_account_list, api_wish_list} from '@/api/selling-profit'
        ...
        computed: {
            tableColumns() {
                return [
                    ...
                    {label: 'P卡费用', value: 'p_fee', handle: this.toFixed2},
                    ...
                    {label: '转运费', value: 'trans_shipping_fee', handle: this.handle_number, hide: this.is_overwarehouse},
